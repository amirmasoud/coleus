...
!function () {
   ...
   var a;!function () {
      ...
      return a = function a() {}, a.extend = function d(a) {
         ...
         for (var h in a) {
            ...
            g[h] = "function" == typeof a[h] && "function" == typeof f[h] && c.test(a[h]) ? function (a, b) {
               return function () {
                  var c = this._super;
                  ...
                  var d = b.apply(this, arguments);return this._super = c, d;
               };
            }(h, a[h]) : a[h];
   ...
   var b = function b(a) {
      ...
      // - DOM nodes
      // - window
      return !("object" != (typeof a === "undefined" ? "undefined" : _typeof(a)) || a.nodeType || null !== a && a === a.window) && !(a.constructor && !Object.prototype.hasOwnProperty.call(a.constructor.prototype, "isPrototypeOf"));
   },
       c = function c(a) {
      var d, e, f;for (e = 1; e < arguments.length; e++) {
         d = arguments[e];for (f in d) {
            d.hasOwnProperty(f) && (d[f] && b(d[f]) ? (a.hasOwnProperty(f) || (a[f] = {}), c(a[f], d[f])) : a[f] = d[f]);
         }
      }return a;
   },
       d = function d(a, b) {
      if (a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a))) {
         var c;if (Array.isArray(a) || "number" == typeof a.length && a.length > 0 && a.length - 1 in a) {
            for (c = 0; c < a.length; c++) {
               if (b(c, a[c]) === !1) return;
            }
         } else if (Object.keys) {
            var d = Object.keys(a);for (c = 0; c < d.length; c++) {
      ...
      constructor: f, init: function init() {
         ...
         if (!this.ready) throw "JSON Editor not ready yet.  Listen for 'ready' event before getting the value";return this.root.getValue();
      }, setValue: function setValue(a) {
         if (!this.ready) throw "JSON Editor not ready yet.  Listen for 'ready' event before setting the value";return this.root.setValue(a), this;
         ...
         // Specific callback
         if (a && b) {
            this.callbacks = this.callbacks || {}, this.callbacks[a] = this.callbacks[a] || [];for (var c = [], d = 0; d < this.callbacks[a].length; d++) {
               this.callbacks[a][d] !== b && c.push(this.callbacks[a][d]);
            }this.callbacks[a] = c;
         } else a ? (this.callbacks = this.callbacks || {}, this.callbacks[a] = []) : this.callbacks = {};return this;
      }, trigger: function trigger(a) {
         if (this.callbacks && this.callbacks[a] && this.callbacks[a].length) for (var b = 0; b < this.callbacks[a].length; b++) {
            this.callbacks[a][b]();
         }return this;
      }, setOption: function setOption(a, b) {
         if ("show_errors" !== a) throw "Option " + a + " must be set during instantiation and cannot be changed later";return this.options.show_errors = b, this.onChange(), this;
      }, getEditorClass: function getEditorClass(a) {
         var b;if (a = this.expandSchema(a), d(f.defaults.resolvers, function (c, d) {
            var e = d(a);if (e && f.defaults.editors[e]) return b = e, !1;
         }), !b) throw "Unknown editor for schema " + JSON.stringify(a);if (!f.defaults.editors[b]) throw "Unknown editor " + b;return f.defaults.editors[b];
      }, createEditor: function createEditor(a, b) {
         return b = c({}, a.options || {}, b), new a(b);
      }, onChange: function onChange() {
         if (this.ready && !this.firing_change) {
            this.firing_change = !0;var a = this;return window.requestAnimationFrame(function () {
               a.firing_change = !1, a.ready && (
      ...
      }, compileTemplate: function compileTemplate(a, b) {
         b = b || f.defaults.template;var c;
         // Specifying a preset engine
         if ("string" == typeof b) {
            if (!f.defaults.templates[b]) throw "Unknown template engine " + b;if (c = f.defaults.templates[b](), !c) throw "Template engine " + b + " missing required library.";
         } else c = b;if (!c) throw "No template engine set";if (!c.compile) throw "Invalid template engine set";return c.compile(a);
      }, _data: function _data(a, b, c) {
         // Setting data
         if (3 !== arguments.length)
            // No data stored
            // No data stored
            return a.hasAttribute("data-jsoneditor-" + b) ? this.__data[a.getAttribute("data-jsoneditor-" + b)] : null;var d;a.hasAttribute("data-jsoneditor-" + b) ? d = a.getAttribute("data-jsoneditor-" + b) : (d = this.uuid++, a.setAttribute("data-jsoneditor-" + b, d)), this.__data[d] = c;
      }, registerEditor: function registerEditor(a) {
         return this.editors = this.editors || {}, this.editors[a.path] = a, this;
      }, unregisterEditor: function unregisterEditor(a) {
      ...
      }, watch: function watch(a, b) {
         return this.watchlist = this.watchlist || {}, this.watchlist[a] = this.watchlist[a] || [], this.watchlist[a].push(b), this;
      }, unwatch: function unwatch(a, b) {
         if (!this.watchlist || !this.watchlist[a]) return this;
         // If removing all callbacks for a path
         if (!b) return this.watchlist[a] = null, this;for (var c = [], d = 0; d < this.watchlist[a].length; d++) {
            this.watchlist[a][d] !== b && c.push(this.watchlist[a][d]);
         }return this.watchlist[a] = c.length ? c : null, this;
      }, notifyWatchers: function notifyWatchers(a) {
         if (!this.watchlist || !this.watchlist[a]) return this;for (var b = 0; b < this.watchlist[a].length; b++) {
            this.watchlist[a][b]();
         }
         ...
         this.root.disable();
      }, _getDefinitions: function _getDefinitions(a, b) {
         if (b = b || "#/definitions/", a.definitions) for (var c in a.definitions) {
      ...
      }, _getExternalRefs: function _getExternalRefs(a) {
         var b = {},
             c = function c(a) {
            for (var c in a) {
               a.hasOwnProperty(c) && (b[c] = !0);
            }
         };a.$ref && "object" != _typeof(a.$ref) && "#" !== a.$ref.substr(0, 1) && !this.refs[a.$ref] && (b[a.$ref] = !0);for (var d in a) {
            if (a.hasOwnProperty(d)) if (a[d] && "object" == _typeof(a[d]) && Array.isArray(a[d])) for (var e = 0; e < a[d].length; e++) {
               "object" == _typeof(a[d][e]) && c(this._getExternalRefs(a[d][e]));
            } else a[d] && "object" == _typeof(a[d]) && c(this._getExternalRefs(a[d]));
         }return b;
      }, _loadExternalRefs: function _loadExternalRefs(a, b) {
         var c = this,
             ...
             h = !1;d(e, function (a) {
            if (!c.refs[a]) {
               if (!c.options.ajax) throw "Must set ajax option to true to load external ref " + a;c.refs[a] = "loading", g++;var d = new XMLHttpRequest();d.open("GET", a, !0), d.onreadystatechange = function () {
                  if (4 == d.readyState) {
                     // Request succeeded
                     if (200 !== d.status) throw window.console.log(d), "Failed to fetch ref via ajax- " + a;var e;try {
                        e = JSON.parse(d.responseText);
                     } catch (i) {
                        throw window.console.log(i), "Failed to parse external ref " + a;
                     }if (!e || "object" != (typeof e === "undefined" ? "undefined" : _typeof(e))) throw "External ref does not contain a valid schema - " + a;c.refs[a] = e, c._loadExternalRefs(e, function () {
                        f++, f >= g && !h && (h = !0, b());
                     });
                  }
               }, d.send();
      ...
      }, expandRefs: function expandRefs(a) {
         for (a = c({}, a); a.$ref;) {
            var b = a.$ref;delete a.$ref, this.refs[b] || (b = decodeURIComponent(b)), a = this.extendSchemas(a, this.refs[b]);
         }return a;
      }, expandSchema: function expandSchema(a) {
         var b,
             e = this,
             f = c({}, a);
         ...
         if (
         // Version 3 `type`
         "object" == _typeof(a.type) && (
         // Array of types
         Array.isArray(a.type) ? d(a.type, function (b, c) {
            // Schema
            "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && (a.type[b] = e.expandSchema(c));
         }) : a.type = e.expandSchema(a.type)),
         // Version 3 `disallow`
         "object" == _typeof(a.disallow) && (
         // Array of types
         Array.isArray(a.disallow) ? d(a.disallow, function (b, c) {
            // Schema
            "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && (a.disallow[b] = e.expandSchema(c));
         }) : a.disallow = e.expandSchema(a.disallow)),
         // Version 4 `anyOf`
         a.anyOf && d(a.anyOf, function (b, c) {
            a.anyOf[b] = e.expandSchema(c);
         }),
         // Version 4 `dependencies` (schema dependencies)
         a.dependencies && d(a.dependencies, function (b, c) {
            "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) || Array.isArray(c) || (a.dependencies[b] = e.expandSchema(c));
         }),
         // Version 4 `not`
         ...
         if (a["extends"]) {
            ...
            if (Array.isArray(a["extends"])) for (b = 0; b < a["extends"].length; b++) {
               f = this.extendSchemas(f, this.expandSchema(a["extends"][b]));
            } else f = this.extendSchemas(f, this.expandSchema(a["extends"]));delete f["extends"];
         }
         // parent should be merged into oneOf schemas
         if (a.oneOf) {
            var g = c({}, f);for (delete g.oneOf, b = 0; b < a.oneOf.length; b++) {
               f.oneOf[b] = this.extendSchemas(this.expandSchema(a.oneOf[b]), g);
            }
         }return this.expandRefs(f);
      }, extendSchemas: function extendSchemas(a, b) {
         a = c({}, a), b = c({}, b);var e = this,
             f = {};
         ...
         return d(a, function (a, c) {
            ...
            "required" !== a && "defaultProperties" !== a || "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) || !Array.isArray(c) ? "type" !== a || "string" != typeof c && !Array.isArray(c) ? "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && Array.isArray(c) ? f[a] = c.filter(function (c) {
               return b[a].indexOf(c) !== -1;
            }) : "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && null !== c ? f[a] = e.extendSchemas(c, b[a]) : f[a] = c : (
            // Make sure we're dealing with arrays
            "string" == typeof c && (c = [c]), "string" == typeof b.type && (b.type = [b.type]),
            // If type is only defined in the first schema, keep it
            b.type && b.type.length ? f.type = c.filter(function (a) {
      ...
      } }, f.defaults = { themes: {}, templates: {}, iconlibs: {}, editors: {}, languages: {}, resolvers: [], custom_validators: [] }, f.Validator = a.extend({ init: function init(a, b, c) {
      ...
      }, _validateSchema: function _validateSchema(a, b, e) {
         var g,
             h,
             i,
             j = this,
         ...
         a = c({}, this.jsoneditor.expandRefs(a)), a.required && a.required === !0) {
            if ("undefined" == typeof b)
               // Can't do any more validation at this point
               return k.push({ path: e, property: "required", message: this.translate("error_notset") }), k;
         ...
         // `extends` (version 3)
         if (a["extends"]) for (h = 0; h < a["extends"].length; h++) {
            k = k.concat(this._validateSchema(a["extends"][h], b, e));
         } // `allOf`
         if (a.allOf) for (h = 0; h < a.allOf.length; h++) {
         ...
         // `oneOf`
         if (a.oneOf) {
            g = 0;var m = [];for (h = 0; h < a.oneOf.length; h++) {
               // Set the error paths to be path.oneOf[i].rest.of.path
               var n = this._validateSchema(a.oneOf[h], b, e);for (n.length || g++, i = 0; i < n.length; i++) {
                  n[i].path = e + ".oneOf[" + h + "]" + n[i].path.substr(e.length);
               }m = m.concat(n);
            }1 !== g && (k.push({ path: e, property: "oneOf", message: this.translate("error_oneOf", [g]) }), k = k.concat(m));
         }
         ...
         a.not && (this._validateSchema(a.not, b, e).length || k.push({ path: e, property: "not", message: this.translate("error_not") })), a.type)
            ...
            } else this._checkType(a.type, b) || k.push({ path: e, property: "type", message: this.translate("error_type", [a.type]) });
         // `disallow` (version 3)
         if (a.disallow)
            // Union type
            if (Array.isArray(a.disallow)) {
               ...
               }g || k.push({ path: e, property: "disallow", message: this.translate("error_disallow_union") });
            } else this._checkType(a.disallow, b) && k.push({ path: e, property: "disallow", message: this.translate("error_disallow", [a.disallow]) }); /*
         ...
         if ("number" == typeof b) {
            ...
            // `pattern`
            a.pattern && (new RegExp(a.pattern).test(b) || k.push({ path: e, property: "pattern", message: this.translate("error_pattern", [a.pattern]) }));else if ("object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && null !== b && Array.isArray(b)) {
            ...
            if (a.items)
               ...
               if (Array.isArray(a.items)) for (h = 0; h < b.length; h++) {
                  ...
                  // Validate against it
                  if (a.items[h]) k = k.concat(this._validateSchema(a.items[h], b[h], e + "." + h));else {
                     if (a.additionalItems === !0) break;if (!a.additionalItems) {
                        if (a.additionalItems === !1) {
                           k.push({ path: e, property: "additionalItems", message: this.translate("error_additionalItems") });break;
                        }break;
            ...
            // `minItems`
            a.minItems && b.length < a.minItems && k.push({ path: e, property: "minItems", message: this.translate("error_minItems", [a.minItems]) }), a.uniqueItems) {
               var p = {};for (h = 0; h < b.length; h++) {
                  if (g = JSON.stringify(b[h]), p[g]) {
                     k.push({ path: e, property: "uniqueItems", message: this.translate("error_uniqueItems") });break;
                  }p[g] = !0;
               }
            }
         } else if ("object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && null !== b) {
            // `maxProperties`
            if (a.maxProperties) {
               g = 0;for (h in b) {
                  b.hasOwnProperty(h) && g++;
               }g > a.maxProperties && k.push({ path: e, property: "maxProperties", message: this.translate("error_maxProperties", [a.maxProperties]) });
            }
            // `minProperties`
            if (a.minProperties) {
               g = 0;for (h in b) {
                  b.hasOwnProperty(h) && g++;
               }g < a.minProperties && k.push({ path: e, property: "minProperties", message: this.translate("error_minProperties", [a.minProperties]) });
            }
            // Version 4 `required`
            if (a.required && Array.isArray(a.required)) for (h = 0; h < a.required.length; h++) {
               "undefined" == typeof b[a.required[h]] && k.push({ path: e, property: "required", message: this.translate("error_required", [a.required[h]]) });
            } // `properties`
            var q = {};if (a.properties) for (h in a.properties) {
               a.properties.hasOwnProperty(h) && (q[h] = !0, k = k.concat(this._validateSchema(a.properties[h], b[h], e + "." + h)));
            } // `patternProperties`
            if (a.patternProperties) for (h in a.patternProperties) {
               if (a.patternProperties.hasOwnProperty(h)) {
                  var r = new RegExp(h);
                  // Check which properties match
                  for (i in b) {
                     b.hasOwnProperty(i) && r.test(i) && (q[i] = !0, k = k.concat(this._validateSchema(a.patternProperties[h], b[i], e + "." + i)));
                  }
               }
            } // `additionalProperties`
            if (
            // The no_additional_properties option currently doesn't work with extended schemas that use oneOf or anyOf
            "undefined" != typeof a.additionalProperties || !this.jsoneditor.options.no_additional_properties || a.oneOf || a.anyOf || (a.additionalProperties = !1), "undefined" != typeof a.additionalProperties) for (h in b) {
               if (b.hasOwnProperty(h) && !q[h]) {
                  // No extra properties allowed
                  if (!a.additionalProperties) {
                     k.push({ path: e, property: "additionalProperties", message: this.translate("error_additional_properties", [h]) });break;
                  }if (a.additionalProperties === !0) break;k = k.concat(this._validateSchema(a.additionalProperties, b[h], e + "." + h));
               }
            } // `dependencies`
            if (a.dependencies) for (h in a.dependencies) {
               if (a.dependencies.hasOwnProperty(h) && "undefined" != typeof b[h])
                  // Property dependency
                  if (Array.isArray(a.dependencies[h])) for (i = 0; i < a.dependencies[h].length; i++) {
                     "undefined" == typeof b[a.dependencies[h][i]] && k.push({ path: e, property: "dependencies", message: this.translate("error_dependency", [a.dependencies[h][i]]) });
      ...
      }, _checkType: function _checkType(a, b) {
         // Simple types
         // Simple types
         return "string" == typeof a ? "string" === a ? "string" == typeof b : "number" === a ? "number" == typeof b : "integer" === a ? "number" == typeof b && b === Math.floor(b) : "boolean" === a ? "boolean" == typeof b : "array" === a ? Array.isArray(b) : "object" === a ? null !== b && !Array.isArray(b) && "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) : "null" !== a || null === b : !this._validateSchema(a, b).length;
      } }), /**
            * All editors should extend from this class
            */
   f.AbstractEditor = a.extend({ onChildEditorChange: function onChildEditorChange(a) {
         this.onChange(!0);
      ...
      }, setContainer: function setContainer(a) {
      ...
      }, preBuild: function preBuild() {}, build: function build() {}, postBuild: function postBuild() {
         ...
         var a = this;if (
         // Watched fields
         this.watched = {}, this.schema.vars && (this.schema.watch = this.schema.vars), this.watched_values = {}, this.watch_listener = function () {
            a.refreshWatchedFieldValues() && a.onWatchedFieldChange();
         }, this.register(), this.schema.hasOwnProperty("watch")) {
            var b, c, d, e, f;for (var g in this.schema.watch) {
               if (this.schema.watch.hasOwnProperty(g)) {
                  if (b = this.schema.watch[g], Array.isArray(b)) {
                     if (b.length < 2) continue;c = [b[0]].concat(b[1].split("."));
                  } else c = b.split("."), a.theme.closest(a.container, '[data-schemaid="' + c[0] + '"]') || c.unshift("#");if (d = c.shift(), "#" === d && (d = a.jsoneditor.schema.id || "root"),
         ...
         // Add links
         if (!this.no_link_holder && (this.link_holder = this.theme.getLinksHolder(), this.container.appendChild(this.link_holder), this.schema.links)) for (var a = 0; a < this.schema.links.length; a++) {
            this.addLink(this.getLink(this.schema.links[a]));
         }
      }, getButton: function getButton(a, b, c) {
         var d = "json-editor-btn-" + b;b = this.iconlib ? this.iconlib.getIcon(b) : null, !b && c && (a = c, c = null);var e = this.theme.getButton(a, b, c);return e.className += " " + d + " ", e;
      }, setButtonText: function setButtonText(a, b, c, d) {
         return c = this.iconlib ? this.iconlib.getIcon(c) : null, !c && d && (b = d, d = null), this.theme.setButtonText(a, b, c, d);
      }, addLink: function addLink(a) {
         ...
         if (a.download && (g = a.download), g && g !== !0 && (g = this.jsoneditor.compileTemplate(g, this.template_engine)), "image" === e) {
            b = this.theme.getBlockLinkHolder(), c = document.createElement("a"), c.setAttribute("target", "_blank");var h = document.createElement("img");this.theme.createImageLink(b, c, h),
            // When a watched field changes, update the url  
            this.link_watchers.push(function (b) {
               var d = f(b);c.setAttribute("href", d), c.setAttribute("title", a.rel || d), h.setAttribute("src", d);
            });
         } else if (["audio", "video"].indexOf(e) >= 0) {
            b = this.theme.getBlockLinkHolder(), c = this.theme.getBlockLink(), c.setAttribute("target", "_blank");var i = document.createElement(e);i.setAttribute("controls", "controls"), this.theme.createMediaLink(b, c, i),
            // When a watched field changes, update the url  
            this.link_watchers.push(function (b) {
               var d = f(b);c.setAttribute("href", d), c.textContent = a.rel || d, i.setAttribute("src", d);
            });
         } else c = b = this.theme.getBlockLink(), b.setAttribute("target", "_blank"), b.textContent = a.rel,
         // When a watched field changes, update the url
         this.link_watchers.push(function (c) {
            var d = f(c);b.setAttribute("href", d), b.textContent = a.rel || d;
         ...
         if (this.watched_values) {
            var a = {},
                b = !1,
                c = this;if (this.watched) {
               var d, e;for (var f in this.watched) {
            ...
            if (this.header.children.length) {
               for (var a = 0; a < this.header.childNodes.length; a++) {
                  if (3 === this.header.childNodes[a].nodeType) {
                     this.header.childNodes[a].nodeValue = this.getHeaderText();break;
                  }
               }
            } else this.header.textContent = this.getHeaderText();
      }, getHeaderText: function getHeaderText(a) {
         ...
         var a;if (this.header_template) {
            a = c(this.getWatchedFieldValues(), { key: this.key, i: this.key, i0: 1 * this.key, i1: 1 * this.key + 1, title: this.getTitle() });var b = this.header_template(a);b !== this.header_text && (this.header_text = b, this.updateHeaderText(), this.notify());
         }if (this.link_watchers.length) {
            a = this.getWatchedFieldValues();for (var d = 0; d < this.link_watchers.length; d++) {
         ...
         return this.value;
      }, refreshValue: function refreshValue() {}, getChildEditors: function getChildEditors() {
         return !1;
      }, destroy: function destroy() {
         var a = this;this.unregister(this), d(this.watched, function (b, c) {
         ...
         if (this.schema["default"]) return this.schema["default"];if (this.schema["enum"]) return this.schema["enum"][0];var a = this.schema.type || this.schema.oneOf;if (a && Array.isArray(a) && (a = a[0]), a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && (a = a.type), a && Array.isArray(a) && (a = a[0]), "string" == typeof a) {
            if ("number" === a) return 0;if ("boolean" === a) return !1;if ("integer" === a) return 0;if ("string" === a) return "";if ("object" === a) return {};if ("array" === a) return [];
         }return null;
      ...
      }, getDisplayText: function getDisplayText(a) {
         var b = [],
             c = {};
      ...
      }, showValidationErrors: function showValidationErrors(a) {} }), f.defaults.editors["null"] = f.AbstractEditor.extend({ getValue: function getValue() {
         return null;
      }, setValue: function setValue() {
         this.onChange();
      }, getNumColumns: function getNumColumns() {
         return 2;
      } }), f.defaults.editors.string = f.AbstractEditor.extend({ register: function register() {
         ...
         if ((!this.template || c) && (null === a || "undefined" == typeof a ? a = "" : "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? a = JSON.stringify(a) : "string" != typeof a && (a = "" + a), a !== this.serialized)) {
            // Sanitize value before setting it
            var d = this.sanitize(a);if (this.input.value !== d) {
               this.input.value = d,
         ...
         var a,
             b = Math.ceil(Math.max(this.getTitle().length, this.schema.maxLength || 0, this.schema.minLength || 0) / 5);return a = "textarea" === this.input_type ? 6 : ["text", "email"].indexOf(this.input_type) >= 0 ? 4 : 2, Math.min(12, Math.max(b, a));
         ...
         if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.format = this.schema.format, !this.format && this.schema.media && this.schema.media.type && (this.format = this.schema.media.type.replace(/(^(application|text)\/(x-)?(script\.)?)|(-source$)/g, "")), !this.format && this.options.default_format && (this.format = this.options.default_format), this.options.format && (this.format = this.options.format), this.format) {
               // Text Area
               if ("textarea" === this.format) this.input_type = "textarea", this.input = this.theme.getTextareaInput();else if ("range" === this.format) {
                  this.input_type = "range";var b = this.schema.minimum || 0,
                      c = this.schema.maximum || Math.max(100, b + 1),
                      d = 1;this.schema.multipleOf && (b % this.schema.multipleOf && (b = Math.ceil(b / this.schema.multipleOf) * this.schema.multipleOf), c % this.schema.multipleOf && (c = Math.floor(c / this.schema.multipleOf) * this.schema.multipleOf), d = this.schema.multipleOf), this.input = this.theme.getRangeInput(b, c, d);
         ...
         "undefined" != typeof this.schema.maxLength && this.input.setAttribute("maxlength", this.schema.maxLength), "undefined" != typeof this.schema.pattern ? this.input.setAttribute("pattern", this.schema.pattern) : "undefined" != typeof this.schema.minLength && this.input.setAttribute("pattern", ".{" + this.schema.minLength + ",}"), this.options.compact ? this.container.className += " compact" : this.options.input_width && (this.input.style.width = this.options.input_width), (this.schema.readOnly || this.schema.readonly || this.schema.template) && (this.always_disabled = !0, this.input.disabled = !0), this.input.addEventListener("change", function (b) {
            ...
            if (b.preventDefault(), b.stopPropagation(), a.schema.template) return void (this.value = a.value);var c = this.value,
                d = a.sanitize(c);c !== d && (this.value = d), a.is_dirty = !0, a.refreshValue(), a.onChange(!0);
            ...
            if (a) {
               var b,
                   c = a.offsetHeight;
               // Input too short
               if (a.offsetHeight < a.scrollHeight) for (b = 0; a.offsetHeight < a.scrollHeight + 3 && !(b > 100);) {
            ...
            a.adjust_height(this);
         }), this.adjust_height()), this.format && this.input.setAttribute("data-schemaformat", this.format), this.control = this.theme.getFormControl(this.label, this.input, this.description), this.container.appendChild(this.control),
         ...
         if (this.source_code)
            ...
            if (this.options.wysiwyg && ["html", "bbcode"].indexOf(this.input_type) >= 0 && window.jQuery && window.jQuery.fn && window.jQuery.fn.sceditor) a = c({}, { plugins: "html" === b.input_type ? "xhtml" : "bbcode", emoticonsEnabled: !1, width: "100%", height: 300 }, f.plugins.sceditor, b.options.sceditor_options || {}), window.jQuery(b.input).sceditor(a), b.sceditor_instance = window.jQuery(b.input).sceditor("instance"), b.sceditor_instance.blur(function () {
               ...
               b.input.value = a.html(), b.value = b.input.value, b.is_dirty = !0, b.onChange(!0);
            });else if ("markdown" === this.input_type && window.EpicEditor) this.epiceditor_container = document.createElement("div"), this.input.parentNode.insertBefore(this.epiceditor_container, this.input), this.input.style.display = "none", a = c({}, f.plugins.epiceditor, { container: this.epiceditor_container, clientSideStorage: !1 }), this.epiceditor = new window.EpicEditor(a).load(), this.epiceditor.importFile(null, this.getValue()), this.epiceditor.on("update", function () {
               var a = b.epiceditor.exportFile();b.input.value = a, b.value = a, b.is_dirty = !0, b.onChange(!0);
            });else if (window.ace) {
               ...
               this.ace_editor.on("change", function () {
                  var a = b.ace_editor.getValue();b.input.value = a, b.refreshValue(), b.is_dirty = !0, b.onChange(!0);
               });
      ...
      onWatchedFieldChange: function onWatchedFieldChange() {
      ...
      }, showValidationErrors: function showValidationErrors(a) {
         var b = this;if ("always" === this.jsoneditor.options.show_errors) ;else if (!this.is_dirty && this.previous_error_setting === this.jsoneditor.options.show_errors) return;this.previous_error_setting = this.jsoneditor.options.show_errors;var c = [];d(a, function (a, d) {
            d.path === b.path && c.push(d.message);
         }), c.length ? this.theme.addInputError(this.input, c.join(". ") + ".") : this.theme.removeInputError(this.input);
      } }), f.defaults.editors.number = f.defaults.editors.string.extend({ sanitize: function sanitize(a) {
         return (a + "").replace(/[^0-9\.\-eE]/g, "");
      }, getNumColumns: function getNumColumns() {
         return 2;
      }, getValue: function getValue() {
         return 1 * this.value;
      } }), f.defaults.editors.integer = f.defaults.editors.number.extend({ sanitize: function sanitize(a) {
         return a += "", a.replace(/[^0-9\-]/g, "");
      }, getNumColumns: function getNumColumns() {
         return 2;
      } }), f.defaults.editors.object = f.AbstractEditor.extend({ getDefault: function getDefault() {
         return c({}, this.schema["default"] || {});
      }, getChildEditors: function getChildEditors() {
         return this.editors;
      }, register: function register() {
         if (this._super(), this.editors) for (var a in this.editors) {
         ...
         if (this.editjson_button && (this.editjson_button.disabled = !1), this.addproperty_button && (this.addproperty_button.disabled = !1), this._super(), this.editors) for (var a in this.editors) {
            this.editors.hasOwnProperty(a) && this.editors[a].enable();
         }
      }, disable: function disable() {
         if (this.editjson_button && (this.editjson_button.disabled = !0), this.addproperty_button && (this.addproperty_button.disabled = !0), this.hideEditJSON(), this._super(), this.editors) for (var a in this.editors) {
            this.editors.hasOwnProperty(a) && this.editors[a].disable();
         }
      }, layoutEditors: function layoutEditors() {
         var a,
             b,
             c = this;if (this.row_container) {
            ...
            this.property_order = Object.keys(this.editors), this.property_order = this.property_order.sort(function (a, b) {
               var d = c.editors[a].schema.propertyOrder,
                   e = c.editors[b].schema.propertyOrder;return "number" != typeof d && (d = 1e3), "number" != typeof e && (e = 1e3), d - e;
            });var e;if ("grid" === this.format) {
               var f = [];
               ...
               for (d(this.property_order, function (a, b) {
                  var d = c.editors[b];if (!d.property_removed) {
                     ...
                     e === !1 && (f.push({ width: 0, minh: 999999, maxh: 0, editors: [] }), e = f.length - 1), f[e].editors.push({ key: b,
                        //editor: editor,
                        width: g, height: h }), f[e].width += g, f[e].minh = Math.min(f[e].minh, h), f[e].maxh = Math.max(f[e].maxh, h);
                  }
               }), a = 0; a < f.length; a++) {
                  if (f[a].width < 12) {
                     var g = !1,
                         h = 0;for (b = 0; b < f[a].editors.length; b++) {
                        g === !1 ? g = b : f[a].editors[b].width > f[a].editors[g].width && (g = b), f[a].editors[b].width *= 12 / f[a].width, f[a].editors[b].width = Math.floor(f[a].editors[b].width), h += f[a].editors[b].width;
                     }h < 12 && (f[a].editors[g].width += 12 - h), f[a].width = 12;
                  }
               } // layout hasn't changed
               if (this.layout === JSON.stringify(f)) return !1;for (this.layout = JSON.stringify(f),
               // Layout the form
               e = document.createElement("div"), a = 0; a < f.length; a++) {
                  var i = this.theme.getGridRow();for (e.appendChild(i), b = 0; b < f[a].editors.length; b++) {
                     var j = f[a].editors[b].key,
                         k = this.editors[j];k.options.hidden ? k.container.style.display = "none" : this.theme.setGridColumnSize(k.container, f[a].editors[b].width), i.appendChild(k.container);
                  }
               }
            } else e = document.createElement("div"), d(this.property_order, function (a, b) {
               var d = c.editors[b];if (!d.property_removed) {
                  var f = c.theme.getGridRow();e.appendChild(f), d.options.hidden ? d.container.style.display = "none" : c.theme.setGridColumnSize(d.container, 12), f.appendChild(d.container);
               }
            });this.row_container.innerHTML = "", this.row_container.appendChild(e);
         }
      }, getPropertySchema: function getPropertySchema(a) {
         // Schema declared directly in properties
         var b = this.schema.properties[a] || {};b = c({}, b);var d = !!this.schema.properties[a];
         // Any matching patternProperties should be merged in
         if (this.schema.patternProperties) for (var e in this.schema.patternProperties) {
            if (this.schema.patternProperties.hasOwnProperty(e)) {
               var f = new RegExp(e);f.test(a) && (b.allOf = b.allOf || [], b.allOf.push(this.schema.patternProperties[e]), d = !0);
            }
         } // Hasn't matched other rules, use additionalProperties schema
         return !d && this.schema.additionalProperties && "object" == _typeof(this.schema.additionalProperties) && (b = c({}, this.schema.additionalProperties)), b;
      }, preBuild: function preBuild() {
         this._super(), this.editors = {}, this.cached_editors = {};var a = this;
         ...
         if (this.format = this.options.layout || this.options.object_layout || this.schema.format || this.jsoneditor.options.object_layout || "normal", this.schema.properties = this.schema.properties || {}, this.minwidth = 0, this.maxwidth = 0, this.options.table_row) d(this.schema.properties, function (b, c) {
            var d = a.jsoneditor.getEditorClass(c);a.editors[b] = a.jsoneditor.createEditor(d, { jsoneditor: a.jsoneditor, schema: c, path: a.path + "." + b, parent: a, compact: !0, required: !0 }), a.editors[b].preBuild();var e = a.editors[b].options.hidden ? 0 : a.editors[b].options.grid_columns || a.editors[b].getNumColumns();a.minwidth += e, a.maxwidth += e;
         }), this.no_link_holder = !0;else {
            if (this.options.table)
               // TODO: table display format
               throw "Not supported yet";this.schema.defaultProperties || (this.jsoneditor.options.display_required_only || this.options.display_required_only ? (this.schema.defaultProperties = [], d(this.schema.properties, function (b, c) {
            ...
            a.maxwidth += 1, d(this.schema.defaultProperties, function (b, c) {
         ...
         this.property_order = Object.keys(this.editors), this.property_order = this.property_order.sort(function (b, c) {
            var d = a.editors[b].schema.propertyOrder,
                e = a.editors[c].schema.propertyOrder;return "number" != typeof d && (d = 1e3), "number" != typeof e && (e = 1e3), d - e;
         });
      }, build: function build() {
         var a = this;
         // If the object should be rendered as a table row
         if (this.options.table_row) this.editor_holder = this.container, d(this.editors, function (b, c) {
            var d = a.theme.getTableCell();a.editor_holder.appendChild(d), c.setContainer(d), c.build(), c.postBuild(), a.editors[b].options.hidden && (d.style.display = "none"), a.editors[b].options.input_width && (d.style.width = a.editors[b].options.input_width);
         });else {
            if (this.options.table)
               // TODO: table display format
            ...
            }), this.editjson_holder.appendChild(this.editjson_textarea), this.editjson_holder.appendChild(this.editjson_save), this.editjson_holder.appendChild(this.editjson_cancel),
            ...
            this.addproperty_holder = this.theme.getModal(), this.addproperty_list = document.createElement("div"), this.addproperty_list.style.width = "295px", this.addproperty_list.style.maxHeight = "160px", this.addproperty_list.style.padding = "5px 0", this.addproperty_list.style.overflowY = "auto", this.addproperty_list.style.overflowX = "hidden", this.addproperty_list.style.paddingLeft = "5px", this.addproperty_list.setAttribute("class", "property-selector"), this.addproperty_add = this.getButton("add", "add", "add"), this.addproperty_input = this.theme.getFormInputField("text"), this.addproperty_input.setAttribute("placeholder", "Property name..."), this.addproperty_input.style.width = "220px", this.addproperty_input.style.marginBottom = "0", this.addproperty_input.style.display = "inline-block", this.addproperty_add.addEventListener("click", function (b) {
               if (b.preventDefault(), b.stopPropagation(), a.addproperty_input.value) {
                  if (a.editors[a.addproperty_input.value]) return void window.alert("there is already a property with that name");a.addObjectProperty(a.addproperty_input.value), a.editors[a.addproperty_input.value] && a.editors[a.addproperty_input.value].disable(), a.onChange(!0);
               }
            }), this.addproperty_holder.appendChild(this.addproperty_list), this.addproperty_holder.appendChild(this.addproperty_input), this.addproperty_holder.appendChild(this.addproperty_add);var b = document.createElement("div");b.style.clear = "both", this.addproperty_holder.appendChild(b),
            // Description
            ...
            this.row_container = this.theme.getGridContainer(), this.editor_holder.appendChild(this.row_container), d(this.editors, function (b, c) {
               var d = a.theme.getGridColumn();a.row_container.appendChild(d), c.setContainer(d), c.build(), c.postBuild();
            }),
            // Control buttons
            this.title_controls = this.theme.getHeaderButtonHolder(), this.editjson_controls = this.theme.getHeaderButtonHolder(), this.addproperty_controls = this.theme.getHeaderButtonHolder(), this.title.appendChild(this.title_controls), this.title.appendChild(this.editjson_controls), this.title.appendChild(this.addproperty_controls),
            // Show/Hide button
            this.collapsed = !1, this.toggle_button = this.getButton("", "collapse", this.translate("button_collapse")), this.title_controls.appendChild(this.toggle_button), this.toggle_button.addEventListener("click", function (b) {
            ...
            // Edit JSON Button
            this.editjson_button = this.getButton("JSON", "edit", "Edit JSON"), this.editjson_button.addEventListener("click", function (b) {
               b.preventDefault(), b.stopPropagation(), a.toggleEditJSON();
            }), this.editjson_controls.appendChild(this.editjson_button), this.editjson_controls.appendChild(this.editjson_holder),
            ...
            this.addproperty_button = this.getButton("Properties", "edit", "Object Properties"), this.addproperty_button.addEventListener("click", function (b) {
         ...
         this.editjson_holder && (this.hideAddProperty(),
         ...
         this.disable(), this.editjson_holder.style.display = "", this.editjson_button.disabled = !1, this.editing_json = !0);
         ...
         if (this.editjson_holder) try {
            var a = JSON.parse(this.editjson_textarea.value);this.setValue(a), this.hideEditJSON();
         } catch (b) {
      ...
      }, insertPropertyControlUsingPropertyOrder: function insertPropertyControlUsingPropertyOrder(a, b, c) {
         var d;this.schema.properties[a] && (d = this.schema.properties[a].propertyOrder), "number" != typeof d && (d = 1e3), b.propertyOrder = d;for (var e = 0; e < c.childNodes.length; e++) {
            var f = c.childNodes[e];if (b.propertyOrder < f.propertyOrder) {
               this.addproperty_list.insertBefore(b, f), b = null;break;
            }
         }b && this.addproperty_list.appendChild(b);
      }, addPropertyCheckbox: function addPropertyCheckbox(a) {
         var b,
             c,
             d,
             e,
         ...
         this.addproperty_holder && (this.hideEditJSON(),
         // Position the form directly beneath the button
         // TODO: edge detection
         ...
         // Disable the rest of the form while editing JSON
         this.disable(), this.adding_property = !0, this.addproperty_button.disabled = !1, this.addproperty_holder.style.display = "", this.refreshAddProperties());
      ...
      }, removeObjectProperty: function removeObjectProperty(a) {
         this.editors[a] && (this.editors[a].unregister(), delete this.editors[a], this.refreshValue(), this.layoutEditors());
      }, addObjectProperty: function addObjectProperty(a, b) {
         var c = this;
         // Property is already added
         if (!this.editors[a]) {
            // Property was added before and is cached
            if (this.cached_editors[a]) {
               if (this.editors[a] = this.cached_editors[a], b) return;this.editors[a].register();
            } else {
               if (!(this.canHaveAdditionalProperties() || this.schema.properties && this.schema.properties[a])) return;var d = c.getPropertySchema(a),
                   e = c.jsoneditor.getEditorClass(d);if (c.editors[a] = c.jsoneditor.createEditor(e, { jsoneditor: c.jsoneditor, schema: d, path: c.path + "." + a, parent: c }), c.editors[a].preBuild(), !b) {
                  var f = c.theme.getChildEditorHolder();c.editor_holder.appendChild(f), c.editors[a].setContainer(f), c.editors[a].build(), c.editors[a].postBuild();
               }c.cached_editors[a] = c.editors[a];
            }
            // If we're only prebuilding the editors, don't refresh values
            b || (c.refreshValue(), c.layoutEditors());
         }
      }, onChildEditorChange: function onChildEditorChange(a) {
         ...
         var a = this._super();if (this.jsoneditor.options.remove_empty_properties || this.options.remove_empty_properties) for (var b in a) {
            a.hasOwnProperty(b) && (a[b] || delete a[b]);
         }return a;
      }, refreshValue: function refreshValue() {
         this.value = {};for (var a in this.editors) {
         ...
         if (this.options.disable_properties || this.options.disable_properties !== !1 && this.jsoneditor.options.disable_properties) return void (this.addproperty_controls.style.display = "none");var a,
             b = !1,
             c = !1,
             d = 0,
             e = !1;
      ...
      }, isRequired: function isRequired(a) {
         ...
         var c = this;a = a || {}, ("object" != (typeof a === "undefined" ? "undefined" : _typeof(a)) || Array.isArray(a)) && (a = {}),
      ...
      } }), f.defaults.editors.array = f.AbstractEditor.extend({ getDefault: function getDefault() {
         return this.schema["default"] || [];
      }, register: function register() {
         if (this._super(), this.rows) for (var a = 0; a < this.rows.length; a++) {
         ...
         if (this.add_row_button && (this.add_row_button.disabled = !1), this.remove_all_rows_button && (this.remove_all_rows_button.disabled = !1), this.delete_last_row_button && (this.delete_last_row_button.disabled = !1), this.rows) for (var a = 0; a < this.rows.length; a++) {
         ...
         if (this.add_row_button && (this.add_row_button.disabled = !0), this.remove_all_rows_button && (this.remove_all_rows_button.disabled = !0), this.delete_last_row_button && (this.delete_last_row_button.disabled = !0), this.rows) for (var a = 0; a < this.rows.length; a++) {
            this.rows[a].disable(), this.rows[a].moveup_button && (this.rows[a].moveup_button.disabled = !0), this.rows[a].movedown_button && (this.rows[a].movedown_button.disabled = !0), this.rows[a].delete_button && (this.rows[a].delete_button.disabled = !0);
         }this._super();
      }, preBuild: function preBuild() {
         ...
         if (!this.item_title) if (this.schema.items && !Array.isArray(this.schema.items)) {
            var a = this.jsoneditor.expandRefs(this.schema.items);this.item_title = a.title || "item";
         } else this.item_title = "item";return this.item_title;
      }, getItemSchema: function getItemSchema(a) {
         ...
         if (this.rows) {
            var b = this;d(this.rows, function (c, d) {
      ...
      }, destroyRow: function destroyRow(a, b) {
         var c = a.container;b ? (a.destroy(), c.parentNode && c.parentNode.removeChild(c), a.tab && a.tab.parentNode && a.tab.parentNode.removeChild(a.tab)) : (a.tab && (a.tab.style.display = "none"), c.style.display = "none", a.unregister());
      ...
      }, refreshTabs: function refreshTabs(a) {
         var b = this;d(this.rows, function (c, d) {
         ...
         a = a || [], Array.isArray(a) || (a = [a]);var c = JSON.stringify(a);if (c !== this.serialized) {
            ...
            if (this.schema.minItems) for (; a.length < this.schema.minItems;) {
               a.push(this.getItemInfo(a.length)["default"]);
            }this.getMax() && a.length > this.getMax() && (a = a.slice(0, this.getMax()));var e = this;d(a, function (a, c) {
               e.rows[a] ?
               // TODO: don't set the row's value if it hasn't changed
               e.rows[a].setValue(c, b) : e.row_cache[a] ? (e.rows[a] = e.row_cache[a], e.rows[a].setValue(c, b), e.rows[a].container.style.display = "", e.rows[a].tab && (e.rows[a].tab.style.display = ""), e.rows[a].register()) : e.addRow(c, b);
            });for (var f = a.length; f < e.rows.length; f++) {
               e.destroyRow(e.rows[f]), e.rows[f] = null;
            }e.rows = e.rows.slice(0, a.length);
            // Set the active tab
            var g = null;d(e.rows, function (a, b) {
      ...
      }, refreshValue: function refreshValue(a) {
         var b = this,
             c = this.value ? this.value.length : 0;if (this.value = [], d(this.rows, function (a, c) {
            ...
            var e = this.schema.minItems && this.schema.minItems >= this.rows.length;d(this.rows, function (a, c) {
               ...
               // Get the value for this editor
               b.value[a] = c.getValue();
            });var f = !1;this.value.length ? 1 === this.value.length ? (this.remove_all_rows_button.style.display = "none",
            ...
            this.getMax() && this.getMax() <= this.rows.length || this.hide_add_button ? this.add_row_button.style.display = "none" : (this.add_row_button.style.display = "", f = !0), !this.collapsed && f ? this.controls.style.display = "inline-block" : this.controls.style.display = "none";
         }
      }, addRow: function addRow(a, b) {
         var c = this,
             e = this.rows.length;c.rows[e] = this.getElementEditor(e), c.row_cache[e] = c.rows[e], c.tabs_holder && (c.rows[e].tab_text = document.createElement("span"), c.rows[e].tab_text.textContent = c.rows[e].getHeaderText(), c.rows[e].tab = c.theme.getTab(c.rows[e].tab_text), c.rows[e].tab.addEventListener("click", function (a) {
            c.active_tab = c.rows[e].tab, c.refreshTabs(), a.preventDefault(), a.stopPropagation();
         }), c.theme.addTab(c.tabs_holder, c.rows[e].tab));var f = c.rows[e].title_controls || c.rows[e].array_controls;
         ...
         c.hide_delete_buttons || (c.rows[e].delete_button = this.getButton(c.getItemTitle(), "delete", this.translate("button_delete_row_title", [c.getItemTitle()])), c.rows[e].delete_button.className += " delete", c.rows[e].delete_button.setAttribute("data-i", e), c.rows[e].delete_button.addEventListener("click", function (a) {
            a.preventDefault(), a.stopPropagation();var b = 1 * this.getAttribute("data-i"),
                e = c.getValue(),
                f = [],
                g = null;d(e, function (a, d) {
            ...
            a.preventDefault(), a.stopPropagation();var b = 1 * this.getAttribute("data-i");if (!(b <= 0)) {
               var d = c.getValue(),
                   e = d[b - 1];d[b - 1] = d[b], d[b] = e, c.setValue(d), c.active_tab = c.rows[b - 1].tab, c.refreshTabs(), c.onChange(!0);
            }
            ...
            a.preventDefault(), a.stopPropagation();var b = 1 * this.getAttribute("data-i"),
                d = c.getValue();if (!(b >= d.length - 1)) {
               var e = d[b + 1];d[b + 1] = d[b], d[b] = e, c.setValue(d), c.active_tab = c.rows[b + 1].tab, c.refreshTabs(), c.onChange(!0);
            }
         }), f && f.appendChild(c.rows[e].movedown_button)), a && c.rows[e].setValue(a, b), c.refreshTabs();
      }, addControls: function addControls() {
         var a = this;this.collapsed = !1, this.toggle_button = this.getButton("", "collapse", this.translate("button_collapse")), this.title_controls.appendChild(this.toggle_button);var b = a.row_holder.style.display,
             c = a.controls.style.display;this.toggle_button.addEventListener("click", function (d) {
         ...
         this.add_row_button = this.getButton(this.getItemTitle(), "add", this.translate("button_add_row_title", [this.getItemTitle()])), this.add_row_button.addEventListener("click", function (b) {
            b.preventDefault(), b.stopPropagation();var c = a.rows.length;a.row_cache[c] ? (a.rows[c] = a.row_cache[c], a.rows[c].setValue(a.rows[c].getDefault(), !0), a.rows[c].container.style.display = "", a.rows[c].tab && (a.rows[c].tab.style.display = ""), a.rows[c].register()) : a.addRow(), a.active_tab = a.rows[c].tab, a.refreshTabs(), a.refreshValue(), a.onChange(!0);
            ...
            b.preventDefault(), b.stopPropagation();var c = a.getValue(),
                d = null;a.rows.length > 1 && a.rows[a.rows.length - 1].tab === a.active_tab && (d = a.rows[a.rows.length - 2].tab), c.pop(), a.setValue(c), d && (a.active_tab = d, a.refreshTabs()), a.onChange(!0);
      ...
      } }), f.defaults.editors.table = f.defaults.editors.array.extend({ register: function register() {
         if (this._super(), this.rows) for (var a = 0; a < this.rows.length; a++) {
            this.rows[a].register();
         }
      }, unregister: function unregister() {
         ...
         var a = this.jsoneditor.expandRefs(this.schema.items || {});this.item_title = a.title || "row", this.item_default = a["default"] || null, this.item_has_child_editors = a.properties || a.items, this.width = 12, this._super();
      }, build: function build() {
         var a = this;this.table = this.theme.getTable(), this.container.appendChild(this.table), this.thead = this.theme.getTableHead(), this.table.appendChild(this.thead), this.header_row = this.theme.getTableRow(), this.thead.appendChild(this.header_row), this.row_holder = this.theme.getTableBody(), this.table.appendChild(this.row_holder);
         ...
         var b = this.getElementEditor(0, !0);if (this.item_default = b.getDefault(), this.width = b.getNumColumns() + 2, this.options.compact ? (this.panel = document.createElement("div"), this.container.appendChild(this.panel)) : (this.title = this.theme.getHeader(this.getTitle()), this.container.appendChild(this.title), this.title_controls = this.theme.getHeaderButtonHolder(), this.title.appendChild(this.title_controls), this.schema.description && (this.description = this.theme.getDescription(this.schema.description), this.container.appendChild(this.description)), this.panel = this.theme.getIndentedPanel(), this.container.appendChild(this.panel), this.error_holder = document.createElement("div"), this.panel.appendChild(this.error_holder)), this.panel.appendChild(this.table), this.controls = this.theme.getButtonHolder(), this.panel.appendChild(this.controls), this.item_has_child_editors) for (var c = b.getChildEditors(), d = b.property_order || Object.keys(c), e = 0; e < d.length; e++) {
            var f = a.theme.getTableHeaderCell(c[d[e]].getTitle());c[d[e]].options.hidden && (f.style.display = "none"), a.header_row.appendChild(f);
         } else a.header_row.appendChild(a.theme.getTableHeaderCell(this.item_title));b.destroy(), this.row_holder.innerHTML = "",
         // Row Controls column
      ...
      }, getElementEditor: function getElementEditor(a, b) {
         var d = c({}, this.schema.items),
             ...
             g = f;this.item_has_child_editors || (g = this.theme.getTableCell(), f.appendChild(g));var h = this.jsoneditor.createEditor(e, { jsoneditor: this.jsoneditor, schema: d, container: g, path: this.path + "." + a, parent: this, compact: !0, table_row: !0 });return h.preBuild(), b || (h.build(), h.postBuild(), h.controls_cell = f.appendChild(this.theme.getTableCell()), h.row = f, h.table_controls = this.theme.getButtonHolder(), h.controls_cell.appendChild(h.table_controls), h.table_controls.style.margin = 0, h.table_controls.style.padding = 0), h;
      }, destroy: function destroy() {
         ...
         if (
         // Update the array's value, adding/removing rows when necessary
         a = a || [], this.schema.minItems) for (; a.length < this.schema.minItems;) {
            a.push(this.getItemDefault());
         }this.schema.maxItems && a.length > this.schema.maxItems && (a = a.slice(0, this.schema.maxItems));var c = JSON.stringify(a);if (c !== this.serialized) {
            var e = !1,
                f = this;d(a, function (a, b) {
               f.rows[a] ?
               // TODO: don't set the row's value if it hasn't changed
               f.rows[a].setValue(b) : (f.addRow(b), e = !0);
            });for (var g = a.length; g < f.rows.length; g++) {
               var h = f.rows[g].container;f.item_has_child_editors || f.rows[g].row.parentNode.removeChild(f.rows[g].row), f.rows[g].destroy(), h.parentNode && h.parentNode.removeChild(h), f.rows[g] = null, e = !0;
         ...
         }), c ? this.controls_header_cell.style.display = "" : this.controls_header_cell.style.display = "none";var e = !1;this.value.length ? 1 === this.value.length ? (this.table.style.display = "", this.remove_all_rows_button.style.display = "none",
         // If there are minItems items in the array, or configured to hide the delete_last_row button, hide the delete button beneath the rows
         ...
         // If there are maxItems in the array, hide the add button beneath the rows
         this.schema.maxItems && this.schema.maxItems <= this.rows.length || this.hide_add_button ? this.add_row_button.style.display = "none" : (this.add_row_button.style.display = "", e = !0), e ? this.controls.style.display = "" : this.controls.style.display = "none";
      }, refreshValue: function refreshValue() {
         var a = this;this.value = [], d(this.rows, function (b, c) {
            // Get the value for this editor
            a.value[b] = c.getValue();
         }), this.serialized = JSON.stringify(this.value);
      }, addRow: function addRow(a) {
         var b = this,
             c = this.rows.length;b.rows[c] = this.getElementEditor(c);var e = b.rows[c].table_controls;
         // Buttons to delete row, move row up, and move row down
         this.hide_delete_buttons || (b.rows[c].delete_button = this.getButton("", "delete", this.translate("button_delete_row_title_short")), b.rows[c].delete_button.className += " delete", b.rows[c].delete_button.setAttribute("data-i", c), b.rows[c].delete_button.addEventListener("click", function (a) {
            a.preventDefault(), a.stopPropagation();var c = 1 * this.getAttribute("data-i"),
                e = b.getValue(),
                f = [];d(e, function (a, b) {
            ...
            a.preventDefault(), a.stopPropagation();var c = 1 * this.getAttribute("data-i");if (!(c <= 0)) {
               var d = b.getValue(),
                   e = d[c - 1];d[c - 1] = d[c], d[c] = e, b.setValue(d), b.onChange(!0);
            }
            ...
            a.preventDefault(), a.stopPropagation();var c = 1 * this.getAttribute("data-i"),
                d = b.getValue();if (!(c >= d.length - 1)) {
               var e = d[c + 1];d[c + 1] = d[c], d[c] = e, b.setValue(d), b.onChange(!0);
            }
         }), e.appendChild(b.rows[c].movedown_button)), a && b.rows[c].setValue(a);
      }, addControls: function addControls() {
         var a = this;this.collapsed = !1, this.toggle_button = this.getButton("", "collapse", this.translate("button_collapse")), this.title_controls && (this.title_controls.appendChild(this.toggle_button), this.toggle_button.addEventListener("click", function (b) {
         ...
         this.add_row_button = this.getButton(this.getItemTitle(), "add", this.translate("button_add_row_title", [this.getItemTitle()])), this.add_row_button.addEventListener("click", function (b) {
            ...
            b.preventDefault(), b.stopPropagation();var c = a.getValue();c.pop(), a.setValue(c), a.onChange(!0);
         }), a.controls.appendChild(this.delete_last_row_button), this.remove_all_rows_button = this.getButton(this.translate("button_delete_all"), "delete", this.translate("button_delete_all_title")), this.remove_all_rows_button.addEventListener("click", function (b) {
            b.preventDefault(), b.stopPropagation(), a.setValue([]), a.onChange(!0);
         }), a.controls.appendChild(this.remove_all_rows_button);
      } }),
   // Multiple Editor (for when `type` is an array)
   f.defaults.editors.multiple = f.AbstractEditor.extend({ register: function register() {
         if (this.editors) {
         ...
         if (this._super(), this.editors) for (var a = 0; a < this.editors.length; a++) {
            this.editors[a] && this.editors[a].unregister();
         }
      }, getNumColumns: function getNumColumns() {
         return this.editors[this.type] ? Math.max(this.editors[this.type].getNumColumns(), 4) : 4;
      }, enable: function enable() {
         if (this.editors) for (var a = 0; a < this.editors.length; a++) {
      ...
      }, switchEditor: function switchEditor(a) {
         var b = this;this.editors[a] || this.buildChildEditor(a);var c = b.getValue();b.type = a, b.register(), d(b.editors, function (a, d) {
      ...
      }, buildChildEditor: function buildChildEditor(a) {
         var b = this,
             d = this.types[a],
             e = b.theme.getChildEditorHolder();b.editor_holder.appendChild(e);var f;"string" == typeof d ? (f = c({}, b.schema), f.type = d) : (f = c({}, b.schema, d), f = b.jsoneditor.expandRefs(f),
         // If we need to merge `required` arrays
         d.required && Array.isArray(d.required) && b.schema.required && Array.isArray(b.schema.required) && (f.required = b.schema.required.concat(d.required)));var g = b.jsoneditor.getEditorClass(f);b.editors[a] = b.jsoneditor.createEditor(g, { jsoneditor: b.jsoneditor, schema: f, container: e, path: b.path, parent: b, required: !0 }), b.editors[a].preBuild(), b.editors[a].build(), b.editors[a].postBuild(), b.editors[a].header && (b.editors[a].header.style.display = "none"), b.editors[a].option = b.switcher_options[a], e.addEventListener("change_header_text", function () {
            b.refreshHeaderText();
         ...
         if (this.types = [], this.type = 0, this.editors = [], this.validators = [], this.keep_values = !0, "undefined" != typeof this.jsoneditor.options.keep_oneof_values && (this.keep_values = this.jsoneditor.options.keep_oneof_values), "undefined" != typeof this.options.keep_oneof_values && (this.keep_values = this.options.keep_oneof_values), this.schema.oneOf) this.oneOf = !0, this.types = this.schema.oneOf, delete this.schema.oneOf;else if (this.schema.anyOf) this.anyOf = !0, this.types = this.schema.anyOf, delete this.schema.anyOf;else {
            if (this.schema.type && "any" !== this.schema.type) Array.isArray(this.schema.type) ? this.types = this.schema.type : this.types = [this.schema.type];else
               // If any of these primitive types are disallowed
               if (this.types = ["string", "number", "integer", "boolean", "object", "array", "null"], this.schema.disallow) {
                  var a = this.schema.disallow;"object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && Array.isArray(a) || (a = [a]);var b = [];d(this.types, function (c, d) {
         ...
         var a = this,
             b = this.container;this.header = this.label = this.theme.getFormInputLabel(this.getTitle()), this.container.appendChild(this.header), this.switcher = this.theme.getSwitcher(this.display_text), b.appendChild(this.switcher), this.switcher.addEventListener("change", function (b) {
            b.preventDefault(), b.stopPropagation(), a.switchEditor(a.display_text.indexOf(this.value)), a.onChange(!0);
         }), this.editor_holder = document.createElement("div"), b.appendChild(this.editor_holder);var e = {};a.jsoneditor.options.custom_validators && (e.custom_validators = a.jsoneditor.options.custom_validators), this.switcher_options = this.theme.getSwitcherOptions(this.switcher), d(this.types, function (b, d) {
            a.editors[b] = !1;var g;"string" == typeof d ? (g = c({}, a.schema), g.type = d) : (g = c({}, a.schema, d),
            // If we need to merge `required` arrays
            d.required && Array.isArray(d.required) && a.schema.required && Array.isArray(a.schema.required) && (g.required = a.schema.required.concat(d.required))), a.validators[b] = new f.Validator(a.jsoneditor, g, e);
         }), this.switchEditor(0);
      }, onChildEditorChange: function onChildEditorChange(a) {
         this.editors[this.type] && (this.refreshValue(), this.refreshHeaderText()), this._super();
      }, refreshHeaderText: function refreshHeaderText() {
         var a = this.getDisplayText(this.types);d(this.switcher_options, function (b, c) {
            c.textContent = a[b];
         });
      }, refreshValue: function refreshValue() {
         ...
         var c = this;d(this.validators, function (b, d) {
         ...
         if (this.oneOf || this.anyOf) {
            var e = this.oneOf ? "oneOf" : "anyOf";d(this.editors, function (f, g) {
               if (g) {
                  var h = b.path + "." + e + "[" + f + "]",
                      i = [];d(a, function (a, d) {
                     if (d.path.substr(0, h.length) === h) {
                        var e = c({}, d);e.path = b.path + e.path.substr(h.length), i.push(e);
                     }
   ...
   f.defaults.editors["enum"] = f.AbstractEditor.extend({ getNumColumns: function getNumColumns() {
         return 4;
      }, build: function build() {
         this.container;this.title = this.header = this.label = this.theme.getFormInputLabel(this.getTitle()), this.container.appendChild(this.title), this.options.enum_titles = this.options.enum_titles || [], this["enum"] = this.schema["enum"], this.selected = 0, this.select_options = [], this.html_values = [];for (var a = this, b = 0; b < this["enum"].length; b++) {
         ...
         // Display area
         this.display_area = this.theme.getIndentedPanel(), this.container.appendChild(this.display_area), this.options.hide_display && (this.display_area.style.display = "none"), this.switcher.addEventListener("change", function () {
         ...
         var a = this;a.selected = -1;var b = JSON.stringify(this.value);return d(this["enum"], function (c, d) {
         ...
         var b = this;if (null === a) return "<em>null</em>";if ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a))) {
            // TODO: use theme
      ...
      } }), f.defaults.editors.select = f.AbstractEditor.extend({ setValue: function setValue(a, b) {
         a = this.typecast(a || "");
         // Sanitize value before setting it
         var c = a;this.enum_values.indexOf(c) < 0 && (c = this.enum_values[0]), this.value !== c && (this.input.value = this.enum_options[this.enum_values.indexOf(c)], this.select2 && this.select2.select2("val", this.input.value), this.value = c, this.onChange());
      }, register: function register() {
         this._super(), this.input && this.input.setAttribute("name", this.formname);
      }, unregister: function unregister() {
         this._super(), this.input && this.input.removeAttribute("name");
      }, getNumColumns: function getNumColumns() {
         if (!this.enum_options) return 3;for (var a = this.getTitle().length, b = 0; b < this.enum_options.length; b++) {
            a = Math.max(a, this.enum_options[b].length + 4);
         }return Math.min(12, Math.max(a / 7, 2));
      }, typecast: function typecast(a) {
         return "boolean" === this.schema.type ? !!a : "number" === this.schema.type ? 1 * a : "integer" === this.schema.type ? Math.floor(1 * a) : "" + a;
      }, getValue: function getValue() {
         return this.value;
      }, preBuild: function preBuild() {
         var a = this;this.input_type = "select", this.enum_options = [], this.enum_values = [], this.enum_display = [];var b;
         // Enum options enumerated
         if (this.schema["enum"]) {
            var e = this.schema.options && this.schema.options.enum_titles || [];d(this.schema["enum"], function (b, c) {
         ...
         } else if ("boolean" === this.schema.type) a.enum_display = this.schema.options && this.schema.options.enum_titles || ["true", "false"], a.enum_options = ["1", ""], a.enum_values = [!0, !1], this.isRequired() || (a.enum_display.unshift(" "), a.enum_options.unshift("undefined"), a.enum_values.unshift(void 0));else {
            ...
            if (this.enumSource = [], this.enum_display = [], this.enum_options = [], this.enum_values = [], Array.isArray(this.schema.enumSource)) for (b = 0; b < this.schema.enumSource.length; b++) {
               ...
               "string" == typeof this.schema.enumSource[b] ? this.enumSource[b] = { source: this.schema.enumSource[b] } : Array.isArray(this.schema.enumSource[b]) ? this.enumSource[b] = this.schema.enumSource[b] : this.enumSource[b] = c({}, this.schema.enumSource[b]);
         ...
         if (window.jQuery && window.jQuery.fn && window.jQuery.fn.select2 && (this.enum_options.length > 2 || this.enum_options.length && this.enumSource)) {
            var a = c({}, f.plugins.select2);this.schema.options && this.schema.options.select2_options && (a = c(a, this.schema.options.select2_options)), this.select2 = window.jQuery(this.input).select2(a);var b = this;this.select2.on("select2-blur", function () {
         ...
         if (this.enumSource) {
            a = this.getWatchedFieldValues();for (var c = [], d = [], e = 0; e < this.enumSource.length; e++) {
               // Constant values
               if (Array.isArray(this.enumSource[e])) c = c.concat(this.enumSource[e]), d = d.concat(this.enumSource[e]);else {
                  var f = [];if (
                  ...
                  f = Array.isArray(this.enumSource[e].source) ? this.enumSource[e].source : a[this.enumSource[e].source]) {
                     ...
                     this.enumSource[e].slice && (f = Array.prototype.slice.apply(f, this.enumSource[e].slice)), this.enumSource[e].filter) {
                        var g = [];for (b = 0; b < f.length; b++) {
                           this.enumSource[e].filter({ i: b, item: f[b], watched: a }) && g.push(f[b]);
                        }f = g;
                     }var h = [],
                         i = [];for (b = 0; b < f.length; b++) {
                        var j = f[b];
                        // Rendered value
            ...
            }var k = this.value;this.theme.setSelectOptions(this.input, c, d), this.enum_options = c, this.enum_display = d, this.enum_values = c, this.select2 && this.select2.select2("destroy"),
      ...
      } }), f.defaults.editors.selectize = f.AbstractEditor.extend({ setValue: function setValue(a, b) {
         a = this.typecast(a || "");
         // Sanitize value before setting it
         var c = a;this.enum_values.indexOf(c) < 0 && (c = this.enum_values[0]), this.value !== c && (this.input.value = this.enum_options[this.enum_values.indexOf(c)], this.selectize && this.selectize[0].selectize.addItem(c), this.value = c, this.onChange());
      }, register: function register() {
         this._super(), this.input && this.input.setAttribute("name", this.formname);
      }, unregister: function unregister() {
         this._super(), this.input && this.input.removeAttribute("name");
         ...
         } else if ("boolean" === this.schema.type) a.enum_display = this.schema.options && this.schema.options.enum_titles || ["true", "false"], a.enum_options = ["1", "0"], a.enum_values = [!0, !1];else {
            if (!this.schema.enumSource) throw "'select' editor requires the enum property to be set.";
            // Shortcut declaration for using a single array
            if (this.enumSource = [], this.enum_display = [], this.enum_options = [], this.enum_values = [], Array.isArray(this.schema.enumSource)) for (b = 0; b < this.schema.enumSource.length; b++) {
               // Shorthand for watched variable
         ...
         var a = this.input.value,
             b = a;this.enum_options.indexOf(a) === -1 && (b = this.enum_options[0]), this.value = this.enum_values[this.enum_options.indexOf(a)], this.onChange(!0);
      }, setupSelectize: function setupSelectize() {
         // If the Selectize library is loaded use it when we have lots of items
         var a = this;if (window.jQuery && window.jQuery.fn && window.jQuery.fn.selectize && (this.enum_options.length >= 2 || this.enum_options.length && this.enumSource)) {
            var b = c({}, f.plugins.selectize);this.schema.options && this.schema.options.selectize_options && (b = c(b, this.schema.options.selectize_options)), this.selectize = window.jQuery(this.input).selectize(c(b, { create: !0, onChange: function onChange() {
                  a.onInputChange();
               } }));
         ...
         if (this.enumSource) {
            a = this.getWatchedFieldValues();for (var c = [], d = [], e = 0; e < this.enumSource.length; e++) {
               // Constant values
               if (Array.isArray(this.enumSource[e])) c = c.concat(this.enumSource[e]), d = d.concat(this.enumSource[e]);else if (a[this.enumSource[e].source]) {
            ...
            }var k = this.value;this.theme.setSelectOptions(this.input, c, d), this.enum_options = c, this.enum_display = d, this.enum_values = c,
            // If the previous value is still in the new select options, stick with it
            ...
            this.updateSelectizeOptions(c) : this.setupSelectize(), this._super();
         }
      }, updateSelectizeOptions: function updateSelectizeOptions(a) {
         var b = this.selectize[0].selectize,
             c = this;b.off(), b.clearOptions();for (var d in a) {
            b.addOption({ value: a[d], text: a[d] });
      ...
      } }), f.defaults.editors.multiselect = f.AbstractEditor.extend({ preBuild: function preBuild() {
         this._super();var a;this.select_options = {}, this.select_values = {};var b = this.jsoneditor.expandRefs(this.schema.items || {}),
             c = b["enum"] || [],
             d = b.options ? b.options.enum_titles || [] : [];for (this.option_keys = [], this.option_titles = [], a = 0; a < c.length; a++) {
            // If the sanitized value is different from the enum value, don't include it
            this.sanitize(c[a]) === c[a] && (this.option_keys.push(c[a] + ""), this.option_titles.push((d[a] || c[a]) + ""), this.select_values[c[a] + ""] = c[a]);
         }
      }, build: function build() {
         var a,
             b = this;if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), !this.schema.format && this.option_keys.length < 8 || "checkbox" === this.schema.format) {
            for (this.input_type = "checkboxes", this.inputs = {}, this.controls = {}, a = 0; a < this.option_keys.length; a++) {
               this.inputs[this.option_keys[a]] = this.theme.getCheckbox(), this.select_options[this.option_keys[a]] = this.inputs[this.option_keys[a]];var c = this.theme.getCheckboxLabel(this.option_titles[a]);this.controls[this.option_keys[a]] = this.theme.getFormControl(c, this.inputs[this.option_keys[a]]);
            ...
            c.preventDefault(), c.stopPropagation();var d = [];for (a = 0; a < b.option_keys.length; a++) {
         ...
         for (a = a || [], "object" != (typeof a === "undefined" ? "undefined" : _typeof(a)) ? a = [a] : Array.isArray(a) || (a = []), c = 0; c < a.length; c++) {
         ...
         if (window.jQuery && window.jQuery.fn && window.jQuery.fn.select2) {
            var a = window.jQuery.extend({}, f.plugins.select2);this.schema.options && this.schema.options.select2_options && (a = c(a, this.schema.options.select2_options)), this.select2 = window.jQuery(this.input).select2(a);var b = this;this.select2.on("select2-blur", function () {
               var a = b.select2.select2("val");b.value = a, b.onChange(!0);
            });
         } else this.select2 = null;
      }, onInputChange: function onInputChange() {
         ...
         var a = this.getTitle().length;for (var b in this.select_values) {
            this.select_values.hasOwnProperty(b) && (a = Math.max(a, (this.select_values[b] + "").length + 4));
         }return Math.min(12, Math.max(a / 7, 2));
      }, updateValue: function updateValue(a) {
         for (var b = !1, c = [], d = 0; d < a.length; d++) {
            if (this.select_options[a[d] + ""]) {
               var e = this.sanitize(this.select_values[a[d]]);c.push(e), e !== a[d] && (b = !0);
            } else b = !0;
         ...
         if (!this.always_disabled) {
            if (this.input) this.input.disabled = !1;else if (this.inputs) for (var a in this.inputs) {
               this.inputs.hasOwnProperty(a) && (this.inputs[a].disabled = !1);
            }this.select2 && this.select2.select2("enable", !0);
         }this._super();
      }, disable: function disable() {
         if (this.input) this.input.disabled = !0;else if (this.inputs) for (var a in this.inputs) {
      ...
      } }), f.defaults.editors.base64 = f.AbstractEditor.extend({ getNumColumns: function getNumColumns() {
         return 4;
      }, build: function build() {
         var a = this;
         ...
         this.input = this.theme.getFormInputField("hidden"), this.container.appendChild(this.input), !this.schema.readOnly && !this.schema.readonly) {
            ...
            this.uploader = this.theme.getFormInputField("file"), this.uploader.addEventListener("change", function (b) {
               if (b.preventDefault(), b.stopPropagation(), this.files && this.files.length) {
                  var c = new FileReader();c.onload = function (b) {
         ...
         if (this.last_preview !== this.value && (this.last_preview = this.value, this.preview.innerHTML = "", this.value)) {
            var a = this.value.match(/^data:([^;,]+)[;,]/);if (a && (a = a[1]), a) {
               if (this.preview.innerHTML = "<strong>Type:</strong> " + a + ", <strong>Size:</strong> " + Math.floor((this.value.length - this.value.split(",")[0].length - 1) / 1.33333) + " bytes", "image" === a.substr(0, 5)) {
                  this.preview.innerHTML += "<br>";var b = document.createElement("img");b.style.maxWidth = "100%", b.style.maxHeight = "100px", b.src = this.value, this.preview.appendChild(b);
               }
      ...
      } }), f.defaults.editors.upload = f.AbstractEditor.extend({ getNumColumns: function getNumColumns() {
         return 4;
      }, build: function build() {
         var a = this;
         // Don't show uploader if this is readonly
         ...
         }var b = this.schema.description;b || (b = ""), this.preview = this.theme.getFormInputDescription(b), this.container.appendChild(this.preview), this.control = this.theme.getFormControl(this.label, this.uploader || this.input, this.preview), this.container.appendChild(this.control);
      }, refreshPreview: function refreshPreview() {
         if (this.last_preview !== this.preview_value && (this.last_preview = this.preview_value, this.preview.innerHTML = "", this.preview_value)) {
            var a = this,
                b = this.preview_value.match(/^data:([^;,]+)[;,]/);b && (b = b[1]), b || (b = "unknown");var c = this.uploader.files[0];if (this.preview.innerHTML = "<strong>Type:</strong> " + b + ", <strong>Size:</strong> " + c.size + " bytes", "image" === b.substr(0, 5)) {
               this.preview.innerHTML += "<br>";var d = document.createElement("img");d.style.maxWidth = "100%", d.style.maxHeight = "100px", d.src = this.preview_value, this.preview.appendChild(d);
            }this.preview.innerHTML += "<br>";var e = this.getButton("Upload", "upload", "Upload");this.preview.appendChild(e), e.addEventListener("click", function (b) {
               b.preventDefault(), e.setAttribute("disabled", "disabled"), a.theme.removeInputError(a.uploader), a.theme.getProgressBar && (a.progressBar = a.theme.getProgressBar(), a.preview.appendChild(a.progressBar)), a.jsoneditor.options.upload(a.path, c, { success: function success(b) {
         ...
         this.preview && this.preview.parentNode && this.preview.parentNode.removeChild(this.preview), this.title && this.title.parentNode && this.title.parentNode.removeChild(this.title), this.input && this.input.parentNode && this.input.parentNode.removeChild(this.input), this.uploader && this.uploader.parentNode && this.uploader.parentNode.removeChild(this.uploader), this._super();
      } }), f.defaults.editors.checkbox = f.AbstractEditor.extend({ setValue: function setValue(a, b) {
      ...
      }, empty: function empty(a) {}, setValue: function setValue(a, b) {
         var c = this;
         // Update the array's value, adding/removing rows when necessary
      ...
      var a = document.documentElement;return a.matches ? "matches" : a.webkitMatchesSelector ? "webkitMatchesSelector" : a.mozMatchesSelector ? "mozMatchesSelector" : a.msMatchesSelector ? "msMatchesSelector" : a.oMatchesSelector ? "oMatchesSelector" : void 0;
   }();f.AbstractTheme = a.extend({ getContainer: function getContainer() {
         return document.createElement("div");
      }, getFloatRightLinkHolder: function getFloatRightLinkHolder() {
         var a = document.createElement("div");return a.style = a.style || {}, a.style.cssFloat = "right", a.style.marginLeft = "10px", a;
      }, getModal: function getModal() {
         var a = document.createElement("div");return a.style.backgroundColor = "white", a.style.border = "1px solid black", a.style.boxShadow = "3px 3px black", a.style.position = "absolute", a.style.zIndex = "10", a.style.display = "none", a;
      }, getGridContainer: function getGridContainer() {
         var a = document.createElement("div");return a;
      }, getGridRow: function getGridRow() {
         var a = document.createElement("div");return a.className = "row", a;
      }, getGridColumn: function getGridColumn() {
         var a = document.createElement("div");return a;
      }, setGridColumnSize: function setGridColumnSize(a, b) {}, getLink: function getLink(a) {
         var b = document.createElement("a");return b.setAttribute("href", "#"), b.appendChild(document.createTextNode(a)), b;
      }, disableHeader: function disableHeader(a) {
         a.style.color = "#ccc";
      }, disableLabel: function disableLabel(a) {
         a.style.color = "#ccc";
      }, enableHeader: function enableHeader(a) {
         a.style.color = "";
      }, enableLabel: function enableLabel(a) {
         a.style.color = "";
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = document.createElement("label");return b.appendChild(document.createTextNode(a)), b;
      }, getCheckboxLabel: function getCheckboxLabel(a) {
         var b = this.getFormInputLabel(a);return b.style.fontWeight = "normal", b;
      }, getHeader: function getHeader(a) {
         var b = document.createElement("h3");return "string" == typeof a ? b.textContent = a : b.appendChild(a), b;
      }, getCheckbox: function getCheckbox() {
         var a = this.getFormInputField("checkbox");return a.style.display = "inline-block", a.style.width = "auto", a;
      }, getMultiCheckboxHolder: function getMultiCheckboxHolder(a, b, c) {
         var d = document.createElement("div");b && (b.style.display = "block", d.appendChild(b));for (var e in a) {
            a.hasOwnProperty(e) && (a[e].style.display = "inline-block", a[e].style.marginRight = "20px", d.appendChild(a[e]));
         }return c && d.appendChild(c), d;
      }, getSelectInput: function getSelectInput(a) {
         var b = document.createElement("select");return a && this.setSelectOptions(b, a), b;
      }, getSwitcher: function getSwitcher(a) {
         var b = this.getSelectInput(a);return b.style.backgroundColor = "transparent", b.style.display = "inline-block", b.style.fontStyle = "italic", b.style.fontWeight = "normal", b.style.height = "auto", b.style.marginBottom = 0, b.style.marginLeft = "5px", b.style.padding = "0 0 0 3px", b.style.width = "auto", b;
      }, getSwitcherOptions: function getSwitcherOptions(a) {
         return a.getElementsByTagName("option");
      }, setSwitcherOptions: function setSwitcherOptions(a, b, c) {
         this.setSelectOptions(a, b, c);
      }, setSelectOptions: function setSelectOptions(a, b, c) {
         c = c || [], a.innerHTML = "";for (var d = 0; d < b.length; d++) {
            var e = document.createElement("option");e.setAttribute("value", b[d]), e.textContent = c[d] || b[d], a.appendChild(e);
         }
      }, getTextareaInput: function getTextareaInput() {
         var a = document.createElement("textarea");return a.style = a.style || {}, a.style.width = "100%", a.style.height = "300px", a.style.boxSizing = "border-box", a;
      }, getRangeInput: function getRangeInput(a, b, c) {
         var d = this.getFormInputField("range");return d.setAttribute("min", a), d.setAttribute("max", b), d.setAttribute("step", c), d;
      }, getFormInputField: function getFormInputField(a) {
         var b = document.createElement("input");return b.setAttribute("type", a), b;
      }, afterInputReady: function afterInputReady(a) {}, getFormControl: function getFormControl(a, b, c) {
         var d = document.createElement("div");return d.className = "form-control", a && d.appendChild(a), "checkbox" === b.type ? a.insertBefore(b, a.firstChild) : d.appendChild(b), c && d.appendChild(c), d;
      }, getIndentedPanel: function getIndentedPanel() {
         var a = document.createElement("div");return a.style = a.style || {}, a.style.paddingLeft = "10px", a.style.marginLeft = "10px", a.style.borderLeft = "1px solid #ccc", a;
      }, getChildEditorHolder: function getChildEditorHolder() {
         return document.createElement("div");
      }, getDescription: function getDescription(a) {
         var b = document.createElement("p");return b.innerHTML = a, b;
      }, getCheckboxDescription: function getCheckboxDescription(a) {
         return this.getDescription(a);
      }, getFormInputDescription: function getFormInputDescription(a) {
         return this.getDescription(a);
         ...
         var d = document.createElement("button");return d.type = "button", this.setButtonText(d, a, b, c), d;
      }, setButtonText: function setButtonText(a, b, c, d) {
      ...
      }, getTableHeaderCell: function getTableHeaderCell(a) {
         var b = document.createElement("th");return b.textContent = a, b;
      }, getTableCell: function getTableCell() {
         var a = document.createElement("td");return a;
      }, getErrorMessage: function getErrorMessage(a) {
         var b = document.createElement("p");return b.style = b.style || {}, b.style.color = "red", b.appendChild(document.createTextNode(a)), b;
      }, addInputError: function addInputError(a, b) {}, removeInputError: function removeInputError(a) {}, addTableRowError: function addTableRowError(a) {}, removeTableRowError: function removeTableRowError(a) {}, getTabHolder: function getTabHolder() {
         var a = document.createElement("div");return a.innerHTML = "<div style='float: left; width: 130px;' class='tabs'></div><div class='content' style='margin-left: 130px;'></div><div style='clear:both;'></div>", a;
      }, applyStyles: function applyStyles(a, b) {
         a.style = a.style || {};for (var c in b) {
            b.hasOwnProperty(c) && (a.style[c] = b[c]);
         }
      }, closest: function closest(a, b) {
         for (; a && a !== document;) {
            if (!a[g]) return !1;if (a[g](b)) return a;a = a.parentNode;
         }return !1;
      }, getTab: function getTab(a) {
         var b = document.createElement("div");return b.appendChild(a), b.style = b.style || {}, this.applyStyles(b, { border: "1px solid #ccc", borderWidth: "1px 0 1px 1px", textAlign: "center", lineHeight: "30px", borderRadius: "5px", borderBottomRightRadius: 0, borderTopRightRadius: 0, fontWeight: "bold", cursor: "pointer" }), b;
      }, getTabContentHolder: function getTabContentHolder(a) {
         return a.children[1];
      }, getTabContent: function getTabContent() {
         return this.getIndentedPanel();
      }, markTabActive: function markTabActive(a) {
         this.applyStyles(a, { opacity: 1, background: "white" });
      }, markTabInactive: function markTabInactive(a) {
         this.applyStyles(a, { opacity: .5, background: "" });
      }, addTab: function addTab(a, b) {
         a.children[0].appendChild(b);
      }, getBlockLink: function getBlockLink() {
         var a = document.createElement("a");return a.style.display = "block", a;
      }, getBlockLinkHolder: function getBlockLinkHolder() {
         var a = document.createElement("div");return a;
      }, getLinksHolder: function getLinksHolder() {
         var a = document.createElement("div");return a;
      }, createMediaLink: function createMediaLink(a, b, c) {
         a.appendChild(b), c.style.width = "100%", a.appendChild(c);
      }, createImageLink: function createImageLink(a, b, c) {
         a.appendChild(b), b.appendChild(c);
      } }), f.defaults.themes.bootstrap2 = f.AbstractTheme.extend({ getRangeInput: function getRangeInput(a, b, c) {
         // TODO: use bootstrap slider
         return this._super(a, b, c);
      }, getGridContainer: function getGridContainer() {
         var a = document.createElement("div");return a.className = "container-fluid", a;
      }, getGridRow: function getGridRow() {
         var a = document.createElement("div");return a.className = "row-fluid", a;
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.display = "inline-block", b.style.fontWeight = "bold", b;
      }, setGridColumnSize: function setGridColumnSize(a, b) {
         a.className = "span" + b;
      }, getSelectInput: function getSelectInput(a) {
         var b = this._super(a);return b.style.width = "auto", b.style.maxWidth = "98%", b;
      }, getFormInputField: function getFormInputField(a) {
         var b = this._super(a);return b.style.width = "98%", b;
      }, afterInputReady: function afterInputReady(a) {
         ...
         var a = document.createElement("div");return a.className = "well well-small", a.style.paddingBottom = 0, a;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = document.createElement("p");return b.className = "help-inline", b.textContent = a, b;
      }, getFormControl: function getFormControl(a, b, c) {
         var d = document.createElement("div");d.className = "control-group";var e = document.createElement("div");return e.className = "controls", a && "checkbox" === b.getAttribute("type") ? (d.appendChild(e), a.className += " checkbox", a.appendChild(b), e.appendChild(a), e.style.height = "30px") : (a && (a.className += " control-label", d.appendChild(a)), e.appendChild(b), d.appendChild(e)), c && e.appendChild(c), d;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a.style.marginLeft = "10px", a;
      }, getButtonHolder: function getButtonHolder() {
         var a = document.createElement("div");return a.className = "btn-group", a;
      }, getButton: function getButton(a, b, c) {
         var d = this._super(a, b, c);return d.className += " btn btn-default", d;
      }, getTable: function getTable() {
         var a = document.createElement("table");return a.className = "table table-bordered", a.style.width = "auto", a.style.maxWidth = "none", a;
      }, addInputError: function addInputError(a, b) {
      ...
      }, removeInputError: function removeInputError(a) {
         ...
         var a = document.createElement("div");return a.className = "tabbable tabs-left", a.innerHTML = "<ul class='nav nav-tabs span2' style='margin-right: 0;'></ul><div class='tab-content span10' style='overflow:visible;'></div>", a;
      }, getTab: function getTab(a) {
         var b = document.createElement("li"),
             c = document.createElement("a");return c.setAttribute("href", "#"), c.appendChild(a), b.appendChild(c), b;
      }, getTabContentHolder: function getTabContentHolder(a) {
         return a.children[1];
      }, getTabContent: function getTabContent() {
         var a = document.createElement("div");return a.className = "tab-pane active", a;
      }, markTabActive: function markTabActive(a) {
         a.className += " active";
      }, markTabInactive: function markTabInactive(a) {
         ...
         var a = document.createElement("div");a.className = "progress";var b = document.createElement("div");return b.className = "bar", b.style.width = "0%", a.appendChild(b), a;
      }, updateProgressBar: function updateProgressBar(a, b) {
         a && (a.firstChild.style.width = b + "%");
      }, updateProgressBarUnknown: function updateProgressBarUnknown(a) {
         a && (a.className = "progress progress-striped active", a.firstChild.style.width = "100%");
      } }), f.defaults.themes.bootstrap3 = f.AbstractTheme.extend({ getSelectInput: function getSelectInput(a) {
         var b = this._super(a);
         //el.style.width = 'auto';
         ...
         var a = document.createElement("textarea");return a.className = "form-control", a;
      }, getRangeInput: function getRangeInput(a, b, c) {
         // TODO: use better slider
         return this._super(a, b, c);
      }, getFormInputField: function getFormInputField(a) {
         var b = this._super(a);return "checkbox" !== a && (b.className += "form-control"), b;
      }, getFormControl: function getFormControl(a, b, c) {
         var d = document.createElement("div");return a && "checkbox" === b.type ? (d.className += " checkbox", a.appendChild(b), a.style.fontSize = "14px", d.style.marginTop = "0", d.appendChild(a), b.style.position = "relative", b.style.cssFloat = "left") : (d.className += " form-group", a && (a.className += " control-label", d.appendChild(a)), d.appendChild(b)), c && d.appendChild(c), d;
      }, getIndentedPanel: function getIndentedPanel() {
         var a = document.createElement("div");return a.className = "well well-sm", a.style.paddingBottom = 0, a;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = document.createElement("p");return b.className = "help-block", b.innerHTML = a, b;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a.style.marginLeft = "10px", a;
      }, getButtonHolder: function getButtonHolder() {
         var a = document.createElement("div");return a.className = "btn-group", a;
         ...
         var a = document.createElement("div");return a.innerHTML = "<div class='tabs list-group col-md-2'></div><div class='col-md-10'></div>", a.className = "rows", a;
      }, getTab: function getTab(a) {
         var b = document.createElement("a");return b.className = "list-group-item", b.setAttribute("href", "#"), b.appendChild(a), b;
      }, markTabActive: function markTabActive(a) {
         a.className += " active";
      }, markTabInactive: function markTabInactive(a) {
         a.className = a.className.replace(/\s?active/g, "");
         ...
         var a = 0,
             b = 100,
             c = 0,
             d = document.createElement("div");d.className = "progress";var e = document.createElement("div");return e.className = "progress-bar", e.setAttribute("role", "progressbar"), e.setAttribute("aria-valuenow", c), e.setAttribute("aria-valuemin", a), e.setAttribute("aria-valuenax", b), e.innerHTML = c + "%", d.appendChild(e), d;
      }, updateProgressBar: function updateProgressBar(a, b) {
         if (a) {
            var c = a.firstChild,
                d = b + "%";c.setAttribute("aria-valuenow", b), c.style.width = d, c.innerHTML = d;
         }
      }, updateProgressBarUnknown: function updateProgressBarUnknown(a) {
         if (a) {
            var b = a.firstChild;a.className = "progress progress-striped active", b.removeAttribute("aria-valuenow"), b.style.width = "100%", b.innerHTML = "";
         }
      } }),
   // Base Foundation theme
   f.defaults.themes.foundation = f.AbstractTheme.extend({ getChildEditorHolder: function getChildEditorHolder() {
         var a = document.createElement("div");return a.style.marginBottom = "15px", a;
      }, getSelectInput: function getSelectInput(a) {
         var b = this._super(a);return b.style.minWidth = "none", b.style.padding = "5px", b.style.marginTop = "3px", b;
      }, getSwitcher: function getSwitcher(a) {
         var b = this._super(a);return b.style.paddingRight = "8px", b;
      }, afterInputReady: function afterInputReady(a) {
         this.closest(a, ".compact") && (a.style.marginBottom = 0), a.group = this.closest(a, ".form-control");
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.display = "inline-block", b;
      }, getFormInputField: function getFormInputField(a) {
         var b = this._super(a);return b.style.width = "100%", b.style.marginBottom = "checkbox" === a ? "0" : "12px", b;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = document.createElement("p");return b.textContent = a, b.style.marginTop = "-10px", b.style.fontStyle = "italic", b;
      }, getIndentedPanel: function getIndentedPanel() {
         var a = document.createElement("div");return a.className = "panel", a.style.paddingBottom = 0, a;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a.style.display = "inline-block", a.style.marginLeft = "10px", a.style.verticalAlign = "middle", a;
      }, getButtonHolder: function getButtonHolder() {
         var a = document.createElement("div");return a.className = "button-group", a;
      }, getButton: function getButton(a, b, c) {
         var d = this._super(a, b, c);return d.className += " small button", d;
      }, addInputError: function addInputError(a, b) {
         ...
         var a = document.createElement("div");a.className = "progress";var b = document.createElement("span");return b.className = "meter", b.style.width = "0%", a.appendChild(b), a;
      }, updateProgressBar: function updateProgressBar(a, b) {
         a && (a.firstChild.style.width = b + "%");
      }, updateProgressBarUnknown: function updateProgressBarUnknown(a) {
   ...
   f.defaults.themes.foundation3 = f.defaults.themes.foundation.extend({ getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this._super();return a.style.fontSize = ".6em", a;
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.fontWeight = "bold", b;
      }, getTabHolder: function getTabHolder() {
         var a = document.createElement("div");return a.className = "row", a.innerHTML = "<dl class='tabs vertical two columns'></dl><div class='tabs-content ten columns'></div>", a;
      }, setGridColumnSize: function setGridColumnSize(a, b) {
         var c = ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve"];a.className = "columns " + c[b];
      }, getTab: function getTab(a) {
         ...
         var a = document.createElement("div");return a.className = "content active", a.style.paddingLeft = "5px", a;
      }, markTabActive: function markTabActive(a) {
         a.className += " active";
      }, markTabInactive: function markTabInactive(a) {
         a.className = a.className.replace(/\s*active/g, "");
   ...
   f.defaults.themes.foundation4 = f.defaults.themes.foundation.extend({ getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this._super();return a.style.fontSize = ".6em", a;
      }, setGridColumnSize: function setGridColumnSize(a, b) {
         a.className = "columns large-" + b;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = this._super(a);return b.style.fontSize = ".8rem", b;
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.fontWeight = "bold", b;
      } }),
   // Foundation 5 Specific Theme
   f.defaults.themes.foundation5 = f.defaults.themes.foundation.extend({ getFormInputDescription: function getFormInputDescription(a) {
         var b = this._super(a);return b.style.fontSize = ".8rem", b;
      }, setGridColumnSize: function setGridColumnSize(a, b) {
         a.className = "columns medium-" + b;
      }, getButton: function getButton(a, b, c) {
         var d = this._super(a, b, c);return d.className = d.className.replace(/\s*small/g, "") + " tiny", d;
      }, getTabHolder: function getTabHolder() {
         var a = document.createElement("div");return a.innerHTML = "<dl class='tabs vertical'></dl><div class='tabs-content vertical'></div>", a;
      }, getTab: function getTab(a) {
         var b = document.createElement("dd"),
             c = document.createElement("a");return c.setAttribute("href", "#"), c.appendChild(a), b.appendChild(c), b;
      }, getTabContentHolder: function getTabContentHolder(a) {
         ...
         a.children[0].appendChild(b);
      } }), f.defaults.themes.foundation6 = f.defaults.themes.foundation5.extend({ getIndentedPanel: function getIndentedPanel() {
         var a = document.createElement("div");return a.className = "callout secondary", a;
      }, getButtonHolder: function getButtonHolder() {
         var a = document.createElement("div");return a.className = "button-group tiny", a.style.marginBottom = 0, a;
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.display = "block", b;
      }, getFormControl: function getFormControl(a, b, c) {
         var d = document.createElement("div");return d.className = "form-control", a && d.appendChild(a), "checkbox" === b.type ? a.insertBefore(b, a.firstChild) : a ? a.appendChild(b) : d.appendChild(b), c && a.appendChild(c), d;
      }, addInputError: function addInputError(a, b) {
         if (a.group) {
            if (a.group.className += " error", a.errmsg) a.errmsg.style.display = "", a.className = "";else {
               var c = document.createElement("span");c.className = "form-error is-visible", a.group.getElementsByTagName("label")[0].appendChild(c), a.className = a.className + " is-invalid-input", a.errmsg = c;
      ...
      } }), f.defaults.themes.html = f.AbstractTheme.extend({ getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b.style.display = "block", b.style.marginBottom = "3px", b.style.fontWeight = "bold", b;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = this._super(a);return b.style.fontSize = ".8em", b.style.margin = 0, b.style.display = "inline-block", b.style.fontStyle = "italic", b;
      }, getIndentedPanel: function getIndentedPanel() {
         var a = this._super();return a.style.border = "1px solid #ddd", a.style.padding = "5px", a.style.margin = "5px", a.style.borderRadius = "3px", a;
      }, getChildEditorHolder: function getChildEditorHolder() {
         var a = this._super();return a.style.marginBottom = "8px", a;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a.style.display = "inline-block", a.style.marginLeft = "10px", a.style.fontSize = ".8em", a.style.verticalAlign = "middle", a;
      }, getTable: function getTable() {
         var a = this._super();return a.style.borderBottom = "1px solid #ccc", a.style.marginBottom = "5px", a;
      }, addInputError: function addInputError(a, b) {
         if (a.style.borderColor = "red", a.errmsg) a.errmsg.style.display = "block";else {
            var c = this.closest(a, ".form-control");a.errmsg = document.createElement("div"), a.errmsg.setAttribute("class", "errmsg"), a.errmsg.style = a.errmsg.style || {}, a.errmsg.style.color = "red", c.appendChild(a.errmsg);
         ...
         var a = 100,
             b = 0,
             c = document.createElement("progress");return c.setAttribute("max", a), c.setAttribute("value", b), c;
      }, updateProgressBar: function updateProgressBar(a, b) {
         a && a.setAttribute("value", b);
      }, updateProgressBarUnknown: function updateProgressBarUnknown(a) {
         a && a.removeAttribute("value");
      } }), f.defaults.themes.jqueryui = f.AbstractTheme.extend({ getTable: function getTable() {
         var a = this._super();return a.setAttribute("cellpadding", 5), a.setAttribute("cellspacing", 0), a;
      }, getTableHeaderCell: function getTableHeaderCell(a) {
         var b = this._super(a);return b.className = "ui-state-active", b.style.fontWeight = "bold", b;
      }, getTableCell: function getTableCell() {
         var a = this._super();return a.className = "ui-widget-content", a;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a.style.marginLeft = "10px", a.style.fontSize = ".6em", a.style.display = "inline-block", a;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = this.getDescription(a);return b.style.marginLeft = "10px", b.style.display = "inline-block", b;
      }, getFormControl: function getFormControl(a, b, c) {
         var d = this._super(a, b, c);return "checkbox" === b.type ? (d.style.lineHeight = "25px", d.style.padding = "3px 0") : d.style.padding = "4px 0 8px 0", d;
      }, getDescription: function getDescription(a) {
         var b = document.createElement("span");return b.style.fontSize = ".8em", b.style.fontStyle = "italic", b.textContent = a, b;
      }, getButtonHolder: function getButtonHolder() {
         var a = document.createElement("div");return a.className = "ui-buttonset", a.style.fontSize = ".7em", a;
      }, getFormInputLabel: function getFormInputLabel(a) {
         var b = document.createElement("label");return b.style.fontWeight = "bold", b.style.display = "block", b.textContent = a, b;
      }, getButton: function getButton(a, b, c) {
         var d = document.createElement("button");d.className = "ui-button ui-widget ui-state-default ui-corner-all",
         // Icon only
         ...
         a.innerHTML = "", a.className = "ui-button ui-widget ui-state-default ui-corner-all",
         // Icon only
         c && !b ? (a.className += " ui-button-icon-only", c.className += " ui-button-icon-primary ui-icon-primary", a.appendChild(c)) : c ? (a.className += " ui-button-text-icon-primary", c.className += " ui-button-icon-primary ui-icon-primary", a.appendChild(c)) : a.className += " ui-button-text-only";var e = document.createElement("span");e.className = "ui-button-text", e.textContent = b || d || ".", a.appendChild(e), a.setAttribute("title", d);
      }, getIndentedPanel: function getIndentedPanel() {
         var a = document.createElement("div");return a.className = "ui-widget-content ui-corner-all", a.style.padding = "1em 1.4em", a.style.marginBottom = "20px", a;
      }, afterInputReady: function afterInputReady(a) {
      ...
      } }), f.defaults.themes.barebones = f.AbstractTheme.extend({ getFormInputLabel: function getFormInputLabel(a) {
         var b = this._super(a);return b;
      }, getFormInputDescription: function getFormInputDescription(a) {
         var b = this._super(a);return b;
      }, getIndentedPanel: function getIndentedPanel() {
         var a = this._super();return a;
      }, getChildEditorHolder: function getChildEditorHolder() {
         var a = this._super();return a;
      }, getHeaderButtonHolder: function getHeaderButtonHolder() {
         var a = this.getButtonHolder();return a;
      }, getTable: function getTable() {
         var a = this._super();return a;
      }, addInputError: function addInputError(a, b) {
         if (a.errmsg) a.errmsg.style.display = "block";else {
            var c = this.closest(a, ".form-control");a.errmsg = document.createElement("div"), a.errmsg.setAttribute("class", "errmsg"), c.appendChild(a.errmsg);
         }a.errmsg.innerHTML = "", a.errmsg.appendChild(document.createTextNode(b));
      }, removeInputError: function removeInputError(a) {
         a.style.borderColor = "", a.errmsg && (a.errmsg.style.display = "none");
      }, getProgressBar: function getProgressBar() {
      ...
      return !!window.EJS && { compile: function compile(a) {
            var b = new window.EJS({ text: a });return function (a) {
               return b.render(a);
            };
         } };
      ...
      return !!window.Hogan && { compile: function compile(a) {
            var b = window.Hogan.compile(a);return function (a) {
               return b.render(a);
            };
         } };
   }, f.defaults.templates.markup = function () {
      return !(!window.Mark || !window.Mark.up) && { compile: function compile(a) {
            return function (b) {
               return window.Mark.up(a, b);
            };
         } };
   }, f.defaults.templates.mustache = function () {
      return !!window.Mustache && { compile: function compile(a) {
            return function (b) {
      ...
      return !!window._ && { compile: function compile(a) {
            return function (b) {
   ...
   f.defaults.translate = function (a, b) {
      var c = f.defaults.languages[f.defaults.language];if (!c) throw "Unknown language " + f.defaults.language;var d = c[a] || f.defaults.languages[f.defaults.default_language][a];if ("undefined" == typeof d) throw "Unknown translate string " + a;if (b) for (var e = 0; e < b.length; e++) {
   ...
   f.defaults.resolvers.unshift(function (a) {
      if (a["enum"]) {
         if ("array" === a.type || "object" === a.type) return "enum";if ("number" === a.type || "integer" === a.type || "string" === a.type) return f.plugins.selectize.enable ? "selectize" : "select";
      }
   }),
   ...
   function () {
      if (window.jQuery || window.Zepto) {
         var a = window.jQuery || window.Zepto;a.jsoneditor = f.defaults, a.fn.jsoneditor = function (a) {
            var b = this,
                c = this.data("jsoneditor");if ("value" === a) {
               if (!c) throw "Must initialize jsoneditor before getting/setting the value";
               // Set value
               if (!(arguments.length > 1)) return c.getValue();c.setValue(arguments[1]);
            } else {
               if ("validate" === a) {
               ...
               }"destroy" === a ? c && (c.destroy(), this.data("jsoneditor", null)) : (
               // Destroy first
               c && c.destroy(),
               // Create editor
