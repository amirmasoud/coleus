<template>
  <coleus-container class="pt-16">
    <div class="flex flex-wrap justify-between mb-8">
      <div class="lg:w-6/12 lg:text-left text-center p-4 sm:p-0">
        <h1 class="text-3xl xl:text-4xl text-coleus-gray font-medium leading-normal mb-6 lg:pt-4">
          The NUXT<span class="text-coleus-lightgreen">JS</span> Team<br>
        </h1>
    ...
    <div class="bg-gray-100 rounded p-8">
      <h2 class="text-2xl xl:text-3xl text-center text-coleus-gray font-medium leading-normal mb-6 pt-4">
          ...
          <div class="bg-gray-100 hover:bg-gray-200 rounded p-6">
            ...
            <div class="text-center pt-4">
              ...
              <div class="text-gray-600 py-1">
                {{ profile.work.role }} <span v-if="profile.work.org" class="text-coleus-lightgreen">@<a :href="profile.work.orgUrl" target="_blank" rel="noopener">{{ profile.work.org }}</a></span>
              </div>
              ...
              <div class="py-2">
                ...
                <a v-if="profile.website" :href="profile.website" rel="noopener" target="_blank" class="mx-1"><website-icon class="h-5 inline-block text-coleus-green hover:text-coleus-lightgreen" /></a>
              </div>
            </div>
          </div>
        </div>
