  ...
  <neg-container>
    <div class="flex justify-between py-16 sm:py-24">
      <div class="lg:w-1/2 xl:w-6/12 text-center lg:text-left p-4 sm:p-0">
        <h1 class="text-3xl xl:text-4xl text-negarin-gray font-medium leading-normal mb-6" v-html="wordings.welcome.attrs.title" />
      ...
      <!-- <div class="hidden lg:block lg:w-5/12 bg-negarin-gray rounded-lg">
        <div class="">
