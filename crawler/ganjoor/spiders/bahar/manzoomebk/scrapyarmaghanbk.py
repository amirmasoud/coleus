...
class scrapyarmaghanbkSpider(scrapy.Spider):
    name = "scrapyarmaghanbk"
    allowed_domains = ["ganjoor.net"]
    if 118 == 1:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/armaghanbk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/armaghanbk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (118 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/manzoomebk/armaghanbk/sh" + str(self.order))
