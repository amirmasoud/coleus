...
class scrapymagasSpider(scrapy.Spider):
    name = "scrapymagas"
    allowed_domains = ["ganjoor.net"]
    if 3 == 1:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/magas/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/magas/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (3 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/manzoomebk/magas/sh" + str(self.order))
