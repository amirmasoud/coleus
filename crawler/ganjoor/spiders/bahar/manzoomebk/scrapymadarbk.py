...
class scrapymadarbkSpider(scrapy.Spider):
    name = "scrapymadarbk"
    allowed_domains = ["ganjoor.net"]
    if 8 == 1:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/madarbk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/madarbk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (8 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/manzoomebk/madarbk/sh" + str(self.order))
