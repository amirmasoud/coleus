...
class scrapytbadSpider(scrapy.Spider):
    name = "scrapytbad"
    allowed_domains = ["ganjoor.net"]
    if 10 == 1:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/tbad/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/manzoomebk/tbad/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (10 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/manzoomebk/tbad/sh" + str(self.order))
