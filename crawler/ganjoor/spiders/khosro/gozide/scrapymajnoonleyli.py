...
class scrapymajnoonleyliSpider(scrapy.Spider):
    name = "scrapymajnoonleyli"
    allowed_domains = ["ganjoor.net"]
    if 31 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/majnoon-leyli/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/majnoon-leyli/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (31 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/majnoon-leyli/sh" + str(self.order))
