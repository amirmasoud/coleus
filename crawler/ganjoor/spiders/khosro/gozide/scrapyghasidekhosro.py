...
class scrapyghasidekhosroSpider(scrapy.Spider):
    name = "scrapyghasidekhosro"
    allowed_domains = ["ganjoor.net"]
    if 6 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/ghaside-khosro/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/ghaside-khosro/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (6 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/ghaside-khosro/sh" + str(self.order))
