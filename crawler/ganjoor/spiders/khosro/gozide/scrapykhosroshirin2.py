...
class scrapykhosroshirin2Spider(scrapy.Spider):
    name = "scrapykhosroshirin2"
    allowed_domains = ["ganjoor.net"]
    if 39 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/khosro-shirin2/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/khosro-shirin2/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (39 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/khosro-shirin2/sh" + str(self.order))
