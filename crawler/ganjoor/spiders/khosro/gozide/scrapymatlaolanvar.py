...
class scrapymatlaolanvarSpider(scrapy.Spider):
    name = "scrapymatlaolanvar"
    allowed_domains = ["ganjoor.net"]
    if 14 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/matlaolanvar/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/matlaolanvar/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (14 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/matlaolanvar/sh" + str(self.order))
