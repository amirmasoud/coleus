...
class scrapyghazalamkhSpider(scrapy.Spider):
    name = "scrapyghazalamkh"
    allowed_domains = ["ganjoor.net"]
    if 1996 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/ghazalamkh/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/ghazalamkh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1996 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/ghazalamkh/sh" + str(self.order))
