...
class scrapy8beheshtSpider(scrapy.Spider):
    name = "scrapy8behesht"
    allowed_domains = ["ganjoor.net"]
    if 2 == 1:
        start_urls = ["https://ganjoor.net/khosro/gozide/8behesht/sh"]
    else:
        start_urls = ["https://ganjoor.net/khosro/gozide/8behesht/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (2 + 1):
            next_page = response.urljoin("https://ganjoor.net/khosro/gozide/8behesht/sh" + str(self.order))
