...
class scrapyghasidepSpider(scrapy.Spider):
    name = "scrapyghasidep"
    allowed_domains = ["ganjoor.net"]
    if 42 == 1:
        start_urls = ["https://ganjoor.net/parvin/divanp/ghasidep/sh"]
    else:
        start_urls = ["https://ganjoor.net/parvin/divanp/ghasidep/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (42 + 1):
            next_page = response.urljoin("https://ganjoor.net/parvin/divanp/ghasidep/sh" + str(self.order))
