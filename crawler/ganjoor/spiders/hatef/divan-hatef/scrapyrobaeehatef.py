...
class scrapyrobaeehatefSpider(scrapy.Spider):
    name = "scrapyrobaeehatef"
    allowed_domains = ["ganjoor.net"]
    if 36 == 1:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/robaee-hatef/sh"]
    else:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/robaee-hatef/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (36 + 1):
            next_page = response.urljoin("https://ganjoor.net/hatef/divan-hatef/robaee-hatef/sh" + str(self.order))
