...
class scrapymotayebatSpider(scrapy.Spider):
    name = "scrapymotayebat"
    allowed_domains = ["ganjoor.net"]
    if 2 == 1:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/motayebat/sh"]
    else:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/motayebat/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (2 + 1):
            next_page = response.urljoin("https://ganjoor.net/hatef/divan-hatef/motayebat/sh" + str(self.order))
