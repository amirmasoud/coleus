...
class scrapymaddetarikhSpider(scrapy.Spider):
    name = "scrapymaddetarikh"
    allowed_domains = ["ganjoor.net"]
    if 45 == 1:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/maddetarikh/sh"]
    else:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/maddetarikh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (45 + 1):
            next_page = response.urljoin("https://ganjoor.net/hatef/divan-hatef/maddetarikh/sh" + str(self.order))
