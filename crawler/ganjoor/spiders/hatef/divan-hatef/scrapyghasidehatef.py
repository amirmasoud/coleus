...
class scrapyghasidehatefSpider(scrapy.Spider):
    name = "scrapyghasidehatef"
    allowed_domains = ["ganjoor.net"]
    if 8 == 1:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/ghaside-hatef/sh"]
    else:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/ghaside-hatef/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (8 + 1):
            next_page = response.urljoin("https://ganjoor.net/hatef/divan-hatef/ghaside-hatef/sh" + str(self.order))
