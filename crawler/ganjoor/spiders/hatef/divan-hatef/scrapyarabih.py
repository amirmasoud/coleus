...
class scrapyarabihSpider(scrapy.Spider):
    name = "scrapyarabih"
    allowed_domains = ["ganjoor.net"]
    if 3 == 1:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/arabih/sh"]
    else:
        start_urls = ["https://ganjoor.net/hatef/divan-hatef/arabih/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (3 + 1):
            next_page = response.urljoin("https://ganjoor.net/hatef/divan-hatef/arabih/sh" + str(self.order))
