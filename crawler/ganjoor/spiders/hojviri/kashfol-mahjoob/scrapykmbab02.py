...
class scrapykmbab02Spider(scrapy.Spider):
    name = "scrapykmbab02"
    allowed_domains = ["ganjoor.net"]
    if 5 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab02/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab02/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (5 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab02/sh" + str(self.order))
