...
class scrapykmbab19Spider(scrapy.Spider):
    name = "scrapykmbab19"
    allowed_domains = ["ganjoor.net"]
    if 2 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab19/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab19/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (2 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab19/sh" + str(self.order))
