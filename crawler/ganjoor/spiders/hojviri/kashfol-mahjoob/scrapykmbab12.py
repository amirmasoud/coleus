...
class scrapykmbab12Spider(scrapy.Spider):
    name = "scrapykmbab12"
    allowed_domains = ["ganjoor.net"]
    if 64 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab12/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab12/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (64 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab12/sh" + str(self.order))
