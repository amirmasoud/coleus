...
class scrapykmbab11Spider(scrapy.Spider):
    name = "scrapykmbab11"
    allowed_domains = ["ganjoor.net"]
    if 4 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab11/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab11/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (4 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab11/sh" + str(self.order))
