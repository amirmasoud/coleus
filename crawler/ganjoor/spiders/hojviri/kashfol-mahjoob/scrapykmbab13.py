...
class scrapykmbab13Spider(scrapy.Spider):
    name = "scrapykmbab13"
    allowed_domains = ["ganjoor.net"]
    if 11 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab13/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab13/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (11 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab13/sh" + str(self.order))
