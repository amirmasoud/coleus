...
class scrapyshkmbab07Spider(scrapy.Spider):
    name = "scrapyshkmbab07"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab07/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab07/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab07/sh" + str(self.order))
