...
class scrapykmbab15Spider(scrapy.Spider):
    name = "scrapykmbab15"
    allowed_domains = ["ganjoor.net"]
    if 45 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab15/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab15/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (45 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab15/sh" + str(self.order))
