...
class scrapykmbab10Spider(scrapy.Spider):
    name = "scrapykmbab10"
    allowed_domains = ["ganjoor.net"]
    if 6 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab10/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab10/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (6 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab10/sh" + str(self.order))
