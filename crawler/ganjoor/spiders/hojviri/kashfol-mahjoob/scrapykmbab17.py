...
class scrapykmbab17Spider(scrapy.Spider):
    name = "scrapykmbab17"
    allowed_domains = ["ganjoor.net"]
    if 8 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab17/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab17/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (8 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab17/sh" + str(self.order))
