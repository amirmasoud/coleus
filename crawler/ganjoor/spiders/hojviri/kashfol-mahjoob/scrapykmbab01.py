...
class scrapykmbab01Spider(scrapy.Spider):
    name = "scrapykmbab01"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab01/sh"]
    else:
        start_urls = ["https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab01/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/hojviri/kashfol-mahjoob/kmbab01/sh" + str(self.order))
