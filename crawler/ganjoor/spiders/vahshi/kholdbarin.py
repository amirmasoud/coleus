...
class kholdbarinSpider(scrapy.Spider):
    name = "kholdbarin"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/vahshi/khold-barin/sh"]
    else:
        start_urls = ["https://ganjoor.net/vahshi/khold-barin/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/vahshi/khold-barin/sh" + str(self.order))
