...
class nazermanzoorSpider(scrapy.Spider):
    name = "nazermanzoor"
    allowed_domains = ["ganjoor.net"]
    if 31 == 1:
        start_urls = ["https://ganjoor.net/vahshi/nazer-manzoor/sh"]
    else:
        start_urls = ["https://ganjoor.net/vahshi/nazer-manzoor/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (31 + 1):
            next_page = response.urljoin("https://ganjoor.net/vahshi/nazer-manzoor/sh" + str(self.order))
