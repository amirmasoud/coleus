...
class farhadshirinSpider(scrapy.Spider):
    name = "farhadshirin"
    allowed_domains = ["ganjoor.net"]
    if 44 == 1:
        start_urls = ["https://ganjoor.net/vahshi/farhad-shirin/sh"]
    else:
        start_urls = ["https://ganjoor.net/vahshi/farhad-shirin/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (44 + 1):
            next_page = response.urljoin("https://ganjoor.net/vahshi/farhad-shirin/sh" + str(self.order))
