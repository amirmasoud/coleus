...
class scrapygheteaSpider(scrapy.Spider):
    name = "scrapyghetea"
    allowed_domains = ["ganjoor.net"]
    if 491 == 1:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghetea/sh"]
    else:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghetea/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (491 + 1):
            next_page = response.urljoin("https://ganjoor.net/anvari/divan-anvari/ghetea/sh" + str(self.order))
