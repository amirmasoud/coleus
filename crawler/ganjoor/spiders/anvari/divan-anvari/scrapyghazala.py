...
class scrapyghazalaSpider(scrapy.Spider):
    name = "scrapyghazala"
    allowed_domains = ["ganjoor.net"]
    if 321 == 1:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghazala/sh"]
    else:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghazala/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (321 + 1):
            next_page = response.urljoin("https://ganjoor.net/anvari/divan-anvari/ghazala/sh" + str(self.order))
