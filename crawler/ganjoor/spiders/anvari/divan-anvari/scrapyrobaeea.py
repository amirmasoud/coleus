...
class scrapyrobaeeaSpider(scrapy.Spider):
    name = "scrapyrobaeea"
    allowed_domains = ["ganjoor.net"]
    if 444 == 1:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/robaeea/sh"]
    else:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/robaeea/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (444 + 1):
            next_page = response.urljoin("https://ganjoor.net/anvari/divan-anvari/robaeea/sh" + str(self.order))
