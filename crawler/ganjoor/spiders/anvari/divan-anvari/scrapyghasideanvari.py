...
class scrapyghasideanvariSpider(scrapy.Spider):
    name = "scrapyghasideanvari"
    allowed_domains = ["ganjoor.net"]
    if 208 == 1:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghaside-anvari/sh"]
    else:
        start_urls = ["https://ganjoor.net/anvari/divan-anvari/ghaside-anvari/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (208 + 1):
            next_page = response.urljoin("https://ganjoor.net/anvari/divan-anvari/ghaside-anvari/sh" + str(self.order))
