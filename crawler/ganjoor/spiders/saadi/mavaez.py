...
class mavaezSpider(scrapy.Spider):
    name = "mavaez"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/saadi/mavaez/mo3at"]
    else:
        start_urls = ["https://ganjoor.net/saadi/mavaez/mo3at" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/saadi/mavaez/mo3at" + str(self.order))
