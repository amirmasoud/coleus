...
class scrapyghazalkhSpider(scrapy.Spider):
    name = "scrapyghazalkh"
    allowed_domains = ["ganjoor.net"]
    if 401 == 1:
        start_urls = ["https://ganjoor.net/khaghani/divankh/ghazalkh/sh"]
    else:
        start_urls = ["https://ganjoor.net/khaghani/divankh/ghazalkh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (401 + 1):
            next_page = response.urljoin("https://ganjoor.net/khaghani/divankh/ghazalkh/sh" + str(self.order))
