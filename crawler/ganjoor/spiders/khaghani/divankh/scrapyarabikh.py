...
class scrapyarabikhSpider(scrapy.Spider):
    name = "scrapyarabikh"
    allowed_domains = ["ganjoor.net"]
    if 10 == 1:
        start_urls = ["https://ganjoor.net/khaghani/divankh/arabikh/sh"]
    else:
        start_urls = ["https://ganjoor.net/khaghani/divankh/arabikh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (10 + 1):
            next_page = response.urljoin("https://ganjoor.net/khaghani/divankh/arabikh/sh" + str(self.order))
