...
class scrapyrobaeekhSpider(scrapy.Spider):
    name = "scrapyrobaeekh"
    allowed_domains = ["ganjoor.net"]
    if 352 == 1:
        start_urls = ["https://ganjoor.net/khaghani/divankh/robaeekh/sh"]
    else:
        start_urls = ["https://ganjoor.net/khaghani/divankh/robaeekh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (352 + 1):
            next_page = response.urljoin("https://ganjoor.net/khaghani/divankh/robaeekh/sh" + str(self.order))
