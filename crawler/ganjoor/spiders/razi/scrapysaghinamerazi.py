...
class scrapysaghinameraziSpider(scrapy.Spider):
    name = "scrapysaghinamerazi"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/razi/saghiname"]
    else:
        start_urls = ["https://ganjoor.net/razi/saghiname" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/razi/saghiname" + str(self.order))
