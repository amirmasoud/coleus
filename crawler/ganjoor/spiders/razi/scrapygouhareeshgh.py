...
class scrapygouhareeshghSpider(scrapy.Spider):
    name = "scrapygouhareeshgh"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/razi/gouhar-e-eshgh/"]
    else:
        start_urls = ["https://ganjoor.net/razi/gouhar-e-eshgh/" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/razi/gouhar-e-eshgh/" + str(self.order))
