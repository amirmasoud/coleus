...
class scrapysougandnameraziSpider(scrapy.Spider):
    name = "scrapysougandnamerazi"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/razi/sougandname"]
    else:
        start_urls = ["https://ganjoor.net/razi/sougandname" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/razi/sougandname" + str(self.order))
