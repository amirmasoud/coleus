...
class scrapyghasidearSpider(scrapy.Spider):
    name = "scrapyghasidear"
    allowed_domains = ["ganjoor.net"]
    if 6 == 1:
        start_urls = ["https://ganjoor.net/razi/ghasidear/sh"]
    else:
        start_urls = ["https://ganjoor.net/razi/ghasidear/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (6 + 1):
            next_page = response.urljoin("https://ganjoor.net/razi/ghasidear/sh" + str(self.order))
