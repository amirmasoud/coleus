...
class scrapyghazalarSpider(scrapy.Spider):
    name = "scrapyghazalar"
    allowed_domains = ["ganjoor.net"]
    if 94 == 1:
        start_urls = ["https://ganjoor.net/razi/ghazalar/sh"]
    else:
        start_urls = ["https://ganjoor.net/razi/ghazalar/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (94 + 1):
            next_page = response.urljoin("https://ganjoor.net/razi/ghazalar/sh" + str(self.order))
