...
class scrapytkh7Spider(scrapy.Spider):
    name = "scrapytkh7"
    allowed_domains = ["ganjoor.net"]
    if 7 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh7/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh7/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (7 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh7/sh" + str(self.order))
