...
class scrapytkh6Spider(scrapy.Spider):
    name = "scrapytkh6"
    allowed_domains = ["ganjoor.net"]
    if 27 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh6/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh6/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (27 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh6/sh" + str(self.order))
