...
class scrapytkh3Spider(scrapy.Spider):
    name = "scrapytkh3"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh3/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh3/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh3/sh" + str(self.order))
