...
class scrapytkh4Spider(scrapy.Spider):
    name = "scrapytkh4"
    allowed_domains = ["ganjoor.net"]
    if 22 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh4/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh4/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (22 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh4/sh" + str(self.order))
