...
class scrapytkh1Spider(scrapy.Spider):
    name = "scrapytkh1"
    allowed_domains = ["ganjoor.net"]
    if 15 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh1/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh1/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (15 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh1/sh" + str(self.order))
