...
class scrapytkh2Spider(scrapy.Spider):
    name = "scrapytkh2"
    allowed_domains = ["ganjoor.net"]
    if 10 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh2/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh2/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (10 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh2/sh" + str(self.order))
