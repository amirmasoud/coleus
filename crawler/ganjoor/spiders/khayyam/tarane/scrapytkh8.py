...
class scrapytkh8Spider(scrapy.Spider):
    name = "scrapytkh8"
    allowed_domains = ["ganjoor.net"]
    if 36 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh8/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh8/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (36 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh8/sh" + str(self.order))
