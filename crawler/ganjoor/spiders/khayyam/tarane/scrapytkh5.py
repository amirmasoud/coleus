...
class scrapytkh5Spider(scrapy.Spider):
    name = "scrapytkh5"
    allowed_domains = ["ganjoor.net"]
    if 17 == 1:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh5/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/tarane/tkh5/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (17 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/tarane/tkh5/sh" + str(self.order))
