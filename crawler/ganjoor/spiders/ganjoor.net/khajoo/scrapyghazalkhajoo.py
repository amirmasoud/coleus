...
class scrapyghazalkhajooSpider(scrapy.Spider):
    name = "scrapyghazalkhajoo"
    allowed_domains = ["ganjoor.net"]
    if 932 == 1:
        start_urls = ["https://ganjoor.net/khajoo/ghazal-khajoo/sh"]
    else:
        start_urls = ["https://ganjoor.net/khajoo/ghazal-khajoo/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (932 + 1):
            next_page = response.urljoin("https://ganjoor.net/khajoo/ghazal-khajoo/sh" + str(self.order))
