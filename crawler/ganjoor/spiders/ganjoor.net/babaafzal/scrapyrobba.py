...
class scrapyrobbaSpider(scrapy.Spider):
    name = "scrapyrobba"
    allowed_domains = ["ganjoor.net"]
    if 192 == 1:
        start_urls = ["https://ganjoor.net/babaafzal/robba/sh"]
    else:
        start_urls = ["https://ganjoor.net/babaafzal/robba/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (192 + 1):
            next_page = response.urljoin("https://ganjoor.net/babaafzal/robba/sh" + str(self.order))
