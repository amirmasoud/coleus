...
class scrapyghazalbaSpider(scrapy.Spider):
    name = "scrapyghazalba"
    allowed_domains = ["ganjoor.net"]
    if 7 == 1:
        start_urls = ["https://ganjoor.net/babaafzal/ghazalba/sh"]
    else:
        start_urls = ["https://ganjoor.net/babaafzal/ghazalba/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (7 + 1):
            next_page = response.urljoin("https://ganjoor.net/babaafzal/ghazalba/sh" + str(self.order))
