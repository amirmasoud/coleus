...
class scrapybaghimandeSpider(scrapy.Spider):
    name = "scrapybaghimande"
    allowed_domains = ["ganjoor.net"]
    if 129 == 1:
        start_urls = ["https://ganjoor.net/roodaki/baghimande/sh"]
    else:
        start_urls = ["https://ganjoor.net/roodaki/baghimande/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (129 + 1):
            next_page = response.urljoin("https://ganjoor.net/roodaki/baghimande/sh" + str(self.order))
