...
class scrapyparakandeSpider(scrapy.Spider):
    name = "scrapyparakande"
    allowed_domains = ["ganjoor.net"]
    if 177 == 1:
        start_urls = ["https://ganjoor.net/roodaki/parakande/sh"]
    else:
        start_urls = ["https://ganjoor.net/roodaki/parakande/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (177 + 1):
            next_page = response.urljoin("https://ganjoor.net/roodaki/parakande/sh" + str(self.order))
