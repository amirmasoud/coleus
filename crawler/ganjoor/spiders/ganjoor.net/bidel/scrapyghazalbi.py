...
class scrapyghazalbiSpider(scrapy.Spider):
    name = "scrapyghazalbi"
    allowed_domains = ["ganjoor.net"]
    if 2827 == 1:
        start_urls = ["https://ganjoor.net/bidel/ghazalbi/sh"]
    else:
        start_urls = ["https://ganjoor.net/bidel/ghazalbi/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (2827 + 1):
            next_page = response.urljoin("https://ganjoor.net/bidel/ghazalbi/sh" + str(self.order))
