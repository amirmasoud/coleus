...
class scrapyamoghSpider(scrapy.Spider):
    name = "scrapyamogh"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/azraghi/amogh/sh"]
    else:
        start_urls = ["https://ganjoor.net/azraghi/amogh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/azraghi/amogh/sh" + str(self.order))
