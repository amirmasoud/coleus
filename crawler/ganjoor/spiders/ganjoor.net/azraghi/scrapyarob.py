...
class scrapyarobSpider(scrapy.Spider):
    name = "scrapyarob"
    allowed_domains = ["ganjoor.net"]
    if 108 == 1:
        start_urls = ["https://ganjoor.net/azraghi/arob/sh"]
    else:
        start_urls = ["https://ganjoor.net/azraghi/arob/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (108 + 1):
            next_page = response.urljoin("https://ganjoor.net/azraghi/arob/sh" + str(self.order))
