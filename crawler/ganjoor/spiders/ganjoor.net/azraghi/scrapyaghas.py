...
class scrapyaghasSpider(scrapy.Spider):
    name = "scrapyaghas"
    allowed_domains = ["ganjoor.net"]
    if 66 == 1:
        start_urls = ["https://ganjoor.net/azraghi/aghas/sh"]
    else:
        start_urls = ["https://ganjoor.net/azraghi/aghas/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (66 + 1):
            next_page = response.urljoin("https://ganjoor.net/azraghi/aghas/sh" + str(self.order))
