...
class scrapyghasidebabataherSpider(scrapy.Spider):
    name = "scrapyghasidebabataher"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/babataher/ghaside"]
    else:
        start_urls = ["https://ganjoor.net/babataher/ghaside" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/babataher/ghaside" + str(self.order))
