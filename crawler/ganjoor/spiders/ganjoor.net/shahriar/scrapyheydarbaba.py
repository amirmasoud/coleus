...
class scrapyheydarbabaSpider(scrapy.Spider):
    name = "scrapyheydarbaba"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/shahriar/heydarbaba/"]
    else:
        start_urls = ["https://ganjoor.net/shahriar/heydarbaba/" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/shahriar/heydarbaba/" + str(self.order))
