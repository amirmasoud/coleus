...
class scrapytorkiSpider(scrapy.Spider):
    name = "scrapytorki"
    allowed_domains = ["ganjoor.net"]
    if 29 == 1:
        start_urls = ["https://ganjoor.net/shahriar/torki/sh"]
    else:
        start_urls = ["https://ganjoor.net/shahriar/torki/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (29 + 1):
            next_page = response.urljoin("https://ganjoor.net/shahriar/torki/sh" + str(self.order))
