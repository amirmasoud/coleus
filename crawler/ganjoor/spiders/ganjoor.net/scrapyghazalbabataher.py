...
class scrapyghazalbabataherSpider(scrapy.Spider):
    name = "scrapyghazalbabataher"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/babataher/ghazal"]
    else:
        start_urls = ["https://ganjoor.net/babataher/ghazal" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/babataher/ghazal" + str(self.order))
