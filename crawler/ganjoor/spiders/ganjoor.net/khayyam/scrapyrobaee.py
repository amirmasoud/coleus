...
class scrapyrobaeeSpider(scrapy.Spider):
    name = "scrapyrobaee"
    allowed_domains = ["ganjoor.net"]
    if 178 == 1:
        start_urls = ["https://ganjoor.net/khayyam/robaee/sh"]
    else:
        start_urls = ["https://ganjoor.net/khayyam/robaee/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (178 + 1):
            next_page = response.urljoin("https://ganjoor.net/khayyam/robaee/sh" + str(self.order))
