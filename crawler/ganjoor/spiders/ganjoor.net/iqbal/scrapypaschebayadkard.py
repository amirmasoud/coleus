...
class scrapypaschebayadkardSpider(scrapy.Spider):
    name = "scrapypaschebayadkard"
    allowed_domains = ["ganjoor.net"]
    if 24 == 1:
        start_urls = ["https://ganjoor.net/iqbal/pas-che-bayad-kard/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/pas-che-bayad-kard/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (24 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/pas-che-bayad-kard/sh" + str(self.order))
