...
class scrapyarmaghanhejazSpider(scrapy.Spider):
    name = "scrapyarmaghanhejaz"
    allowed_domains = ["ganjoor.net"]
    if 393 == 1:
        start_urls = ["https://ganjoor.net/iqbal/armaghan-hejaz/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/armaghan-hejaz/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (393 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/armaghan-hejaz/sh" + str(self.order))
