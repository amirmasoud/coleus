...
class scrapypayammashreghSpider(scrapy.Spider):
    name = "scrapypayammashregh"
    allowed_domains = ["ganjoor.net"]
    if 300 == 1:
        start_urls = ["https://ganjoor.net/iqbal/payam-mashregh/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/payam-mashregh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (300 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/payam-mashregh/sh" + str(self.order))
