...
class scrapyjavidnameSpider(scrapy.Spider):
    name = "scrapyjavidname"
    allowed_domains = ["ganjoor.net"]
    if 62 == 1:
        start_urls = ["https://ganjoor.net/iqbal/javidname/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/javidname/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (62 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/javidname/sh" + str(self.order))
