...
class scrapyasrarkhodiSpider(scrapy.Spider):
    name = "scrapyasrarkhodi"
    allowed_domains = ["ganjoor.net"]
    if 20 == 1:
        start_urls = ["https://ganjoor.net/iqbal/asrar-khodi/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/asrar-khodi/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (20 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/asrar-khodi/sh" + str(self.order))
