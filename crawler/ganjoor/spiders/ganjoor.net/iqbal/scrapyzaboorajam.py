...
class scrapyzaboorajamSpider(scrapy.Spider):
    name = "scrapyzaboorajam"
    allowed_domains = ["ganjoor.net"]
    if 142 == 1:
        start_urls = ["https://ganjoor.net/iqbal/zaboor-ajam/sh"]
    else:
        start_urls = ["https://ganjoor.net/iqbal/zaboor-ajam/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (142 + 1):
            next_page = response.urljoin("https://ganjoor.net/iqbal/zaboor-ajam/sh" + str(self.order))
