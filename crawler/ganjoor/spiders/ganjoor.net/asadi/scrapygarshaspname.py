...
class scrapygarshaspnameSpider(scrapy.Spider):
    name = "scrapygarshaspname"
    allowed_domains = ["ganjoor.net"]
    if 144 == 1:
        start_urls = ["https://ganjoor.net/asadi/garshaspname/sh"]
    else:
        start_urls = ["https://ganjoor.net/asadi/garshaspname/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (144 + 1):
            next_page = response.urljoin("https://ganjoor.net/asadi/garshaspname/sh" + str(self.order))
