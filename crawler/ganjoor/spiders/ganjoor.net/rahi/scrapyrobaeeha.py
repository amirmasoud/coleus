...
class scrapyrobaeehaSpider(scrapy.Spider):
    name = "scrapyrobaeeha"
    allowed_domains = ["ganjoor.net"]
    if 19 == 1:
        start_urls = ["https://ganjoor.net/rahi/robaeeha/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/robaeeha/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (19 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/robaeeha/sh" + str(self.order))
