...
class scrapyghazalha1Spider(scrapy.Spider):
    name = "scrapyghazalha1"
    allowed_domains = ["ganjoor.net"]
    if 24 == 1:
        start_urls = ["https://ganjoor.net/rahi/ghazalha1/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/ghazalha1/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (24 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/ghazalha1/sh" + str(self.order))
