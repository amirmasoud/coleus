...
class scrapyghazalha4Spider(scrapy.Spider):
    name = "scrapyghazalha4"
    allowed_domains = ["ganjoor.net"]
    if 25 == 1:
        start_urls = ["https://ganjoor.net/rahi/ghazalha4/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/ghazalha4/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (25 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/ghazalha4/sh" + str(self.order))
