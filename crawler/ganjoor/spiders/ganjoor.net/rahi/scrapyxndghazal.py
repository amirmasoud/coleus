...
class scrapyxndghazalSpider(scrapy.Spider):
    name = "scrapyxndghazal"
    allowed_domains = ["ganjoor.net"]
    if 5 == 1:
        start_urls = ["https://ganjoor.net/rahi/xndghazal/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/xndghazal/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (5 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/xndghazal/sh" + str(self.order))
