...
class scrapyghazalha3Spider(scrapy.Spider):
    name = "scrapyghazalha3"
    allowed_domains = ["ganjoor.net"]
    if 22 == 1:
        start_urls = ["https://ganjoor.net/rahi/ghazalha3/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/ghazalha3/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (22 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/ghazalha3/sh" + str(self.order))
