...
class scrapymanzoomehaSpider(scrapy.Spider):
    name = "scrapymanzoomeha"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/rahi/manzoomeha/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/manzoomeha/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/manzoomeha/sh" + str(self.order))
