...
class scrapyabyatSpider(scrapy.Spider):
    name = "scrapyabyat"
    allowed_domains = ["ganjoor.net"]
    if 16 == 1:
        start_urls = ["https://ganjoor.net/rahi/abyat/sh"]
    else:
        start_urls = ["https://ganjoor.net/rahi/abyat/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (16 + 1):
            next_page = response.urljoin("https://ganjoor.net/rahi/abyat/sh" + str(self.order))
