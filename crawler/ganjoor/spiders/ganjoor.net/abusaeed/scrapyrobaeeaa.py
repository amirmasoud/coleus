...
class scrapyrobaeeaaSpider(scrapy.Spider):
    name = "scrapyrobaeeaa"
    allowed_domains = ["ganjoor.net"]
    if 724 == 1:
        start_urls = ["https://ganjoor.net/abusaeed/robaee-aa/sh"]
    else:
        start_urls = ["https://ganjoor.net/abusaeed/robaee-aa/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (724 + 1):
            next_page = response.urljoin("https://ganjoor.net/abusaeed/robaee-aa/sh" + str(self.order))
