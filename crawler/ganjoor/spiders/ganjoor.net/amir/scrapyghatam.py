...
class scrapyghatamSpider(scrapy.Spider):
    name = "scrapyghatam"
    allowed_domains = ["ganjoor.net"]
    if 34 == 1:
        start_urls = ["https://ganjoor.net/amir/ghatam/sh"]
    else:
        start_urls = ["https://ganjoor.net/amir/ghatam/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (34 + 1):
            next_page = response.urljoin("https://ganjoor.net/amir/ghatam/sh" + str(self.order))
