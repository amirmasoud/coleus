...
class scrapytaramSpider(scrapy.Spider):
    name = "scrapytaram"
    allowed_domains = ["ganjoor.net"]
    if 3 == 1:
        start_urls = ["https://ganjoor.net/amir/taram/sh"]
    else:
        start_urls = ["https://ganjoor.net/amir/taram/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (3 + 1):
            next_page = response.urljoin("https://ganjoor.net/amir/taram/sh" + str(self.order))
