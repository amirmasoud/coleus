...
class scrapyrobamSpider(scrapy.Spider):
    name = "scrapyrobam"
    allowed_domains = ["ganjoor.net"]
    if 174 == 1:
        start_urls = ["https://ganjoor.net/amir/robam/sh"]
    else:
        start_urls = ["https://ganjoor.net/amir/robam/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (174 + 1):
            next_page = response.urljoin("https://ganjoor.net/amir/robam/sh" + str(self.order))
