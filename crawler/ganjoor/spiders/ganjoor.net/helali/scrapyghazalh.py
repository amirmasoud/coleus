...
class scrapyghazalhSpider(scrapy.Spider):
    name = "scrapyghazalh"
    allowed_domains = ["ganjoor.net"]
    if 421 == 1:
        start_urls = ["https://ganjoor.net/helali/ghazalh/sh"]
    else:
        start_urls = ["https://ganjoor.net/helali/ghazalh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (421 + 1):
            next_page = response.urljoin("https://ganjoor.net/helali/ghazalh/sh" + str(self.order))
