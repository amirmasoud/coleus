...
class scrapyghasidehSpider(scrapy.Spider):
    name = "scrapyghasideh"
    allowed_domains = ["ganjoor.net"]
    if 4 == 1:
        start_urls = ["https://ganjoor.net/helali/ghasideh/sh"]
    else:
        start_urls = ["https://ganjoor.net/helali/ghasideh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (4 + 1):
            next_page = response.urljoin("https://ganjoor.net/helali/ghasideh/sh" + str(self.order))
