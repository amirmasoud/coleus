...
class scrapyrobaeehSpider(scrapy.Spider):
    name = "scrapyrobaeeh"
    allowed_domains = ["ganjoor.net"]
    if 35 == 1:
        start_urls = ["https://ganjoor.net/helali/robaeeh/sh"]
    else:
        start_urls = ["https://ganjoor.net/helali/robaeeh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (35 + 1):
            next_page = response.urljoin("https://ganjoor.net/helali/robaeeh/sh" + str(self.order))
