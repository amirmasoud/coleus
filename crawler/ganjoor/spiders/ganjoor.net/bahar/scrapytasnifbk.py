...
class scrapytasnifbkSpider(scrapy.Spider):
    name = "scrapytasnifbk"
    allowed_domains = ["ganjoor.net"]
    if 18 == 1:
        start_urls = ["https://ganjoor.net/bahar/tasnifbk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/tasnifbk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (18 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/tasnifbk/sh" + str(self.order))
