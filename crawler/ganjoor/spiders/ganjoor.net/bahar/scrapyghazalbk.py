...
class scrapyghazalbkSpider(scrapy.Spider):
    name = "scrapyghazalbk"
    allowed_domains = ["ganjoor.net"]
    if 101 == 1:
        start_urls = ["https://ganjoor.net/bahar/ghazalbk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/ghazalbk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (101 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/ghazalbk/sh" + str(self.order))
