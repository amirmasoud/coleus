...
class scrapymahalibkSpider(scrapy.Spider):
    name = "scrapymahalibk"
    allowed_domains = ["ganjoor.net"]
    if 9 == 1:
        start_urls = ["https://ganjoor.net/bahar/mahalibk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/mahalibk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (9 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/mahalibk/sh" + str(self.order))
