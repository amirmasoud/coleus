...
class scrapyghasidebkSpider(scrapy.Spider):
    name = "scrapyghasidebk"
    allowed_domains = ["ganjoor.net"]
    if 276 == 1:
        start_urls = ["https://ganjoor.net/bahar/ghasidebk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/ghasidebk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (276 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/ghasidebk/sh" + str(self.order))
