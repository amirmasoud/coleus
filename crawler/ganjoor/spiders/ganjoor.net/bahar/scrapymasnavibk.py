...
class scrapymasnavibkSpider(scrapy.Spider):
    name = "scrapymasnavibk"
    allowed_domains = ["ganjoor.net"]
    if 84 == 1:
        start_urls = ["https://ganjoor.net/bahar/masnavibk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/masnavibk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (84 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/masnavibk/sh" + str(self.order))
