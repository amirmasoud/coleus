...
class scrapyrobaeebkSpider(scrapy.Spider):
    name = "scrapyrobaeebk"
    allowed_domains = ["ganjoor.net"]
    if 71 == 1:
        start_urls = ["https://ganjoor.net/bahar/robaeebk/sh"]
    else:
        start_urls = ["https://ganjoor.net/bahar/robaeebk/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (71 + 1):
            next_page = response.urljoin("https://ganjoor.net/bahar/robaeebk/sh" + str(self.order))
