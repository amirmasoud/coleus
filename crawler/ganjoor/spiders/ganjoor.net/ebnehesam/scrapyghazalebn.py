...
class scrapyghazalebnSpider(scrapy.Spider):
    name = "scrapyghazalebn"
    allowed_domains = ["ganjoor.net"]
    if 178 == 1:
        start_urls = ["https://ganjoor.net/ebnehesam/ghazalebn/sh"]
    else:
        start_urls = ["https://ganjoor.net/ebnehesam/ghazalebn/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (178 + 1):
            next_page = response.urljoin("https://ganjoor.net/ebnehesam/ghazalebn/sh" + str(self.order))
