...
class scrapyrobaeebnSpider(scrapy.Spider):
    name = "scrapyrobaeebn"
    allowed_domains = ["ganjoor.net"]
    if 100 == 1:
        start_urls = ["https://ganjoor.net/ebnehesam/robaeebn/sh"]
    else:
        start_urls = ["https://ganjoor.net/ebnehesam/robaeebn/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (100 + 1):
            next_page = response.urljoin("https://ganjoor.net/ebnehesam/robaeebn/sh" + str(self.order))
