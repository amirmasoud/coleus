...
class scrapymosammatamirSpider(scrapy.Spider):
    name = "scrapymosammatamir"
    allowed_domains = ["ganjoor.net"]
    if 1 == 1:
        start_urls = ["https://ganjoor.net/amir/mosammat"]
    else:
        start_urls = ["https://ganjoor.net/amir/mosammat" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (1 + 1):
            next_page = response.urljoin("https://ganjoor.net/amir/mosammat" + str(self.order))
