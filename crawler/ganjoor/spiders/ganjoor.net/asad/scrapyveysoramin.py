...
class scrapyveysoraminSpider(scrapy.Spider):
    name = "scrapyveysoramin"
    allowed_domains = ["ganjoor.net"]
    if 113 == 1:
        start_urls = ["https://ganjoor.net/asad/veysoramin/sh"]
    else:
        start_urls = ["https://ganjoor.net/asad/veysoramin/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (113 + 1):
            next_page = response.urljoin("https://ganjoor.net/asad/veysoramin/sh" + str(self.order))
