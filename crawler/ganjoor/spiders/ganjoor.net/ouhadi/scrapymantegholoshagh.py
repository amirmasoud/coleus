...
class scrapymantegholoshaghSpider(scrapy.Spider):
    name = "scrapymantegholoshagh"
    allowed_domains = ["ganjoor.net"]
    if 77 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/mantegholoshagh/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/mantegholoshagh/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (77 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/mantegholoshagh/sh" + str(self.order))
