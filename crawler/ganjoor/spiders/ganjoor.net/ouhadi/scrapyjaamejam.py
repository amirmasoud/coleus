...
class scrapyjaamejamSpider(scrapy.Spider):
    name = "scrapyjaamejam"
    allowed_domains = ["ganjoor.net"]
    if 131 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/jaamejam/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/jaamejam/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (131 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/jaamejam/sh" + str(self.order))
