...
class scrapyrobaeenSpider(scrapy.Spider):
    name = "scrapyrobaeen"
    allowed_domains = ["ganjoor.net"]
    if 4 == 1:
        start_urls = ["https://ganjoor.net/naserkhosro/divann/robaeen/sh"]
    else:
        start_urls = ["https://ganjoor.net/naserkhosro/divann/robaeen/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (4 + 1):
            next_page = response.urljoin("https://ganjoor.net/naserkhosro/divann/robaeen/sh" + str(self.order))
