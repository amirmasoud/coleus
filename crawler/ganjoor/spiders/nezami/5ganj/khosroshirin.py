...
class khosroshirinSpider(scrapy.Spider):
    name = "khosroshirin"
    allowed_domains = ["ganjoor.net"]
    if 121 == 1:
        start_urls = ["https://ganjoor.net/nezami/5ganj/khosro-shirin/sh"]
    else:
        start_urls = ["https://ganjoor.net/nezami/5ganj/khosro-shirin/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (121 + 1):
            next_page = response.urljoin("https://ganjoor.net/nezami/5ganj/khosro-shirin/sh" + str(self.order))
