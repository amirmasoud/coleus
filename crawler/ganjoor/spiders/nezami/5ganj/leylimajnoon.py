...
class leylimajnoonSpider(scrapy.Spider):
    name = "leylimajnoon"
    allowed_domains = ["ganjoor.net"]
    if 46 == 1:
        start_urls = ["https://ganjoor.net/nezami/5ganj/leyli-majnoon/sh"]
    else:
        start_urls = ["https://ganjoor.net/nezami/5ganj/leyli-majnoon/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (46 + 1):
            next_page = response.urljoin("https://ganjoor.net/nezami/5ganj/leyli-majnoon/sh" + str(self.order))
