...
class makhzanolasrarSpider(scrapy.Spider):
    name = "makhzanolasrar"
    allowed_domains = ["ganjoor.net"]
    if 60 == 1:
        start_urls = ["https://ganjoor.net/nezami/5ganj/makhzanolasrar/sh"]
    else:
        start_urls = ["https://ganjoor.net/nezami/5ganj/makhzanolasrar/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (60 + 1):
            next_page = response.urljoin("https://ganjoor.net/nezami/5ganj/makhzanolasrar/sh" + str(self.order))
