...
class kheradnameSpider(scrapy.Spider):
    name = "kheradname"
    allowed_domains = ["ganjoor.net"]
    if 50 == 1:
        start_urls = ["https://ganjoor.net/nezami/5ganj/kheradname/sh"]
    else:
        start_urls = ["https://ganjoor.net/nezami/5ganj/kheradname/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (50 + 1):
            next_page = response.urljoin("https://ganjoor.net/nezami/5ganj/kheradname/sh" + str(self.order))
