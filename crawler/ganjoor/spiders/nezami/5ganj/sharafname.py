...
class sharafnameSpider(scrapy.Spider):
    name = "sharafname"
    allowed_domains = ["ganjoor.net"]
    if 63 == 1:
        start_urls = ["https://ganjoor.net/nezami/5ganj/sharafname/sh"]
    else:
        start_urls = ["https://ganjoor.net/nezami/5ganj/sharafname/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (63 + 1):
            next_page = response.urljoin("https://ganjoor.net/nezami/5ganj/sharafname/sh" + str(self.order))
