...
class scrapyrobaeeoSpider(scrapy.Spider):
    name = "scrapyrobaeeo"
    allowed_domains = ["ganjoor.net"]
    if 184 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/divano/robaeeo/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/divano/robaeeo/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (184 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/divano/robaeeo/sh" + str(self.order))
