...
class scrapytarjeeatoSpider(scrapy.Spider):
    name = "scrapytarjeeato"
    allowed_domains = ["ganjoor.net"]
    if 2 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/divano/tarjeeato/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/divano/tarjeeato/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (2 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/divano/tarjeeato/sh" + str(self.order))
