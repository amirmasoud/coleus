...
class scrapyghazaloSpider(scrapy.Spider):
    name = "scrapyghazalo"
    allowed_domains = ["ganjoor.net"]
    if 887 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/divano/ghazalo/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/divano/ghazalo/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (887 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/divano/ghazalo/sh" + str(self.order))
