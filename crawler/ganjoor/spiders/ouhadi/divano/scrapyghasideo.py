...
class scrapyghasideoSpider(scrapy.Spider):
    name = "scrapyghasideo"
    allowed_domains = ["ganjoor.net"]
    if 42 == 1:
        start_urls = ["https://ganjoor.net/ouhadi/divano/ghasideo/sh"]
    else:
        start_urls = ["https://ganjoor.net/ouhadi/divano/ghasideo/sh" + "1"]
    order = 1
    ...
    def parse(self, response):
        ...
        if self.order < (42 + 1):
            next_page = response.urljoin("https://ganjoor.net/ouhadi/divano/ghasideo/sh" + str(self.order))
