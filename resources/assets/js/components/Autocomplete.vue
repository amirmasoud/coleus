  ...
  methods: {
    ...
    doAjax(val) {
      ...
      ajax.addEventListener('loadend', (e) => {
        ...
        this.author = this.process ? this.process(json.author) : json.author;
        this.book = this.process ? this.process(json.book) : json.book;
        this.table = this.process ? this.process(json.table) : json.table;
        this.content = this.process ? this.process(json.content) : json.content;
      });
      // Send Ajax
      ajax.send();
    },
